<?php
   ...
   error_reporting(0);
   if ($_SESSION['UID'] == '') {
    // header("Location: login.php?page=SI_IA"); 
    echo "<script>alert('You do not have permission to access this section')</script>";
        echo "<script>window.location.href='login.php?page=SI_IA'</script>";
   }
   ...
   if ($_GET['gsw'] != '') {
        $GETgsw = $_GET['gsw'];
           $query2 = "SELECT DISTINCT * from internal_audit_si WHERE GAPStandardWise = '$GETgsw' AND DeletedStatus = '0' AND sort != '0' ORDER BY sort ASC";
           $query2z = "SELECT DISTINCT * from internal_audit_si WHERE GAPStandardWise = '$GETgsw' AND DeletedStatus = '0' AND sort = '0' ORDER BY sort ASC";
           $query2d1 = "SELECT DISTINCT * from internal_audit_si WHERE GAPStandardWise = '$GETgsw' AND DeletedStatus = '0' AND DocumentsTitle != '' ORDER BY sort ASC";
           $query2y1 = "SELECT DISTINCT * from internal_audit_si WHERE GAPStandardWise = '$GETgsw' AND DeletedStatus = '0' AND VideoTitle != '' ORDER BY sort ASC";
           $query2t1 = "SELECT DISTINCT * from internal_audit_si WHERE GAPStandardWise = '$GETgsw' AND DeletedStatus = '0' AND TrainingModulesTitle != '' ORDER BY sort ASC";
...
<html lang="en">
   ...
   <body>
      ...
      <!--            <h1 class="display-3 text-white animated slideInDown" style="font-size: 45px;">Internal Audit (Sustainable Initiatives)</h1>-->
               ...
               <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                  <form action="" method="GET">
                     <div class="row g-3">
                        ...
                        <div class="col-md-2">
                           <h5>&nbsp;</h5>
                           <a href="Internal-Audit-About_SI.php" target="_blank" style="color: #fff;" class="btn btn-info w-100 py-3" type="submit">About This Section</a>
                        </div>
                        <!--<div class="col-md-2">-->
                        <!--   <h5>&nbsp;</h5>-->
                        <!--   <a href="internal-audit-related-documents_SI.php" target="_blank" style="color: #fff;" class="btn btn-info w-100 py-3" type="submit">Related Documents</a>-->
                        <!--</div>-->
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-2">
                              <a href="Internal_audit_SI/<?php echo $row21['Document_Upload']; ?>" target="_blank"><i style="font-size: 30px;" class="ti-files btn-icon-prepend"></i></a>            
                           </div>
                           <div class="col-md-3">
