<?php
   ...
   if ($_GET['gsw'] != '') {
    ...
    //   }
       ...
       $query = mysqli_query($db, "SELECT * from related_documents WHERE PageName = 'Food Safety Standards' AND GAPStandardWise = '$GETgsw' AND DeletedStatus='0' ORDER BY RelatedDocumentId ASC");
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-10 text-center">
                  <h1 class="display-3 text-white animated slideInDown">Food Safety Standards Related Documents</h1>
            ...
            <div class="col-md-4">
               ...
               <div class="form-floating">
                  <select id="gswselector" name="gsw" class="form-control" required="" onchange="if (this.value) window.location.href=this.value">
                     <option value="food-safety-standards-related-documents.php">All</option>
                                 <option <?php if($_GET['gsw'] == 'IndGAP'){echo "selected";} ?> value="food-safety-standards-related-documents.php?gsw=IndGAP">IndG.A.P</option>
                                 <option <?php if($_GET['gsw'] == 'GLOBALGAP'){echo "selected";} ?> value="food-safety-standards-related-documents.php?gsw=GLOBALGAP">GLOBALG.A.P</option>
                                 <option <?php if($_GET['gsw'] == 'OrganicNPOP'){echo "selected";} ?> value="food-safety-standards-related-documents.php?gsw=OrganicNPOP">Organic NPOP</option>
                                 <option <?php if($_GET['gsw'] == 'OrganicNOP'){echo "selected";} ?> value="food-safety-standards-related-documents.php?gsw=OrganicNOP">Organic NOP</option>
