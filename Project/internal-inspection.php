<?php
   ...
   error_reporting(0);
   if ($_SESSION['UID'] == '') {
    header("Location: login.php?page=OFP_II");
   }
   ...
   if (!in_array('On Farm Production', explode(',',$_SESSION["PlanDetails"]))) {
    ...
    echo "<script>alert('You do not have permission to access this section')</script>";
        echo "<script>window.location.href='login.php?page=OFP_II'</script>";
   }
   $query1 = mysqli_query($db, "SELECT DISTINCT crop.CropId, crop.CropName from crop INNER JOIN internal_inspection ON crop.CropId = internal_inspection.Crop AND internal_inspection.DeletedStatus='0' ORDER BY crop.CropName");
   if ($_GET['gsw'] != '' AND $_GET['crp'] != '') {
       ...
       if ($_GET['crp'] == '00') {
           $query2 = "SELECT DISTINCT * from internal_inspection WHERE GAPStandardWise = '$GETgsw' AND DeletedStatus = '0' AND sort != '0' AND Language = '$_GET[lg]' ORDER BY sort ASC";
           $query2z = "SELECT DISTINCT * from internal_inspection WHERE GAPStandardWise = '$GETgsw' AND DeletedStatus = '0' AND sort = '0' AND Language = '$_GET[lg]' ORDER BY sort ASC";
           $query2d1 = "SELECT DISTINCT * from internal_inspection WHERE GAPStandardWise = '$GETgsw' AND DeletedStatus = '0' AND DocumentsTitle != '' AND Language = '$_GET[lg]' ORDER BY sort ASC";
           $query2y1 = "SELECT DISTINCT * from internal_inspection WHERE GAPStandardWise = '$GETgsw' AND DeletedStatus = '0' AND VideoTitle != '' AND Language = '$_GET[lg]' ORDER BY sort ASC";
           $query2t1 = "SELECT DISTINCT * from internal_inspection WHERE GAPStandardWise = '$GETgsw' AND DeletedStatus = '0' AND TrainingModulesTitle != '' AND Language = '$_GET[lg]' ORDER BY sort ASC";
       } else {
           $query2 = "SELECT * from internal_inspection WHERE GAPStandardWise = '$GETgsw' AND Crop = '$_GET[crp]' AND DeletedStatus = '0' AND sort != '0' AND Language = '$_GET[lg]' ORDER BY sort ASC";
           $query2z = "SELECT * from internal_inspection WHERE GAPStandardWise = '$GETgsw' AND Crop = '$_GET[crp]' AND DeletedStatus = '0' AND sort = '0' AND Language = '$_GET[lg]' ORDER BY sort ASC";
           $query2d1 = "SELECT * from internal_inspection WHERE GAPStandardWise = '$GETgsw' AND Crop = '$_GET[crp]' AND DeletedStatus = '0' AND DocumentsTitle != '' AND Language = '$_GET[lg]' ORDER BY sort ASC";
           $query2y1 = "SELECT * from internal_inspection WHERE GAPStandardWise = '$GETgsw' AND Crop = '$_GET[crp]' AND DeletedStatus = '0' AND VideoTitle != '' AND Language = '$_GET[lg]' ORDER BY sort ASC";
           $query2t1 = "SELECT * from internal_inspection WHERE GAPStandardWise = '$GETgsw' AND Crop = '$_GET[crp]' AND DeletedStatus = '0' AND TrainingModulesTitle != '' AND Language = '$_GET[lg]' ORDER BY sort ASC";
       }
   }
   ?>
<!DOCTYPE html>
                  ...
                  <form action="" method="GET">
                     <div class="row g-3">
                        ...
                        <div class="col-md-2">
                           <h5>Language</h5>
                           <div class="form-floating">
                              <select name="lg" class="form-control" required="">
                        ...
                        <div class="col-md-2">
                           <h5>&nbsp;</h5>
                           <a href="Internal-Inspection-About.pdf" target="_blank" style="color: #fff;" class="btn btn-info w-100 py-3" type="submit">About This Section</a>
                        </div>
                        <!--<div class="col-md-2">-->
                        <!--   <h5>&nbsp;</h5>-->
                        <!--   <a href="internal-inspection-related-documents.php" target="_blank" style="color: #fff;" class="btn btn-info w-100 py-3" type="submit">Related Documents</a>-->
                        <!--</div>-->
                        <div style="margin-top: 25px;">
                           <p><b>Note:</b> Internal Inspection requirements are generic and apply to all crops-Whether Grape or Mango or Vegetables etc .You need to use the inspection checklist as applicable to specific crops while inspecting the Producer  Group Members  Inspections.<br>
                              <b>Example:</b> All farm Base and Crops Base Modules  apply to all Crops . Then based on the crop category ,you can use Fruits & Vegetables or Combinable Crops inspection checklists.
                           </p>
                        </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-2">
                              <?php
                                    ...
                                    <a href="internal-inspection-pdf.php?doc=<?php echo $row21['InternalInspectionID']; ?>" target="_blank"><i style="font-size: 30px;" class="ti-files btn-icon-prepend"></i></a>
                                    <?php } ?>             
                           </div>
                           <div class="col-md-3">
                        ...
                        <?php if( mysqli_num_rows(mysqli_query($db,$query2)) == 0 AND ($_GET['gsw'] == 'OrganicNOP' OR $_GET['gsw'] == 'RainforestAlliance')){?>
                        <!--<center>-->
