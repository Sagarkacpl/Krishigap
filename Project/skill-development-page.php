               ...
               <div class="col-lg-10 text-center">
                  ...
                  <nav aria-label="breadcrumb">
                     <ol class="breadcrumb justify-content-center">
                        <a href='training-module.php' class="btn btn-success btn-sm">Go Back</a>
                     </ol>
                  </nav>
               </div>
            </div>
      ...
      <div class="container-xxl py-5">
         <div class="conatiner">
            <div class="table-bg">
               ...
               <form action="skill-development-page.php" method="get">
                  <div class="row mt-5">
                     <div class="col-md-4">
                        <h5>Year</h5>
                        <div class="form-floating">
                           <select class="form-control" name="Year" required="" id="Year">
                              ...
                              <?php
                                 $year = "SELECT YEAR(StartDate) `year` FROM schedule WHERE EndDate < CURDATE() AND DeletedStatus='0' GROUP BY YEAR(StartDate)";
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-floating">
                           <select name="Month" class="form-control" required="" id="Month">
                              ...
                              <?php
                                 $query = "SELECT MONTH(StartDate) `Month`, YEAR(StartDate) `year` FROM schedule WHERE EndDate < CURDATE() AND YEAR(StartDate)='$_GET[Year]' AND DeletedStatus='0'  GROUP BY MONTH(StartDate),YEAR(StartDate)";
               ...
               <table class="mt-5">
                  ...
                  <?php
                     if ($_GET['Month'] != '00') {
                         ...
                         $schedule = "SELECT Course,TopicCovered,StartDate,EndDate,Duration,FacultyOrganization,Fees,Feedback,FacultyName, EXTRACT(YEAR FROM StartDate) AS Year, EXTRACT(MONTH FROM StartDate) AS Month FROM `schedule` WHERE EndDate < CURDATE() AND Year(StartDate)='$select_year' AND Month(StartDate)='$select_Month' AND DeletedStatus='0' GROUP BY Course,TopicCovered,StartDate,EndDate,Duration,FacultyOrganization,Fees,Feedback,FacultyName";
                  ...
                  <tr>
                     ...
                     <td>
                        <a href="trainee_list.php?Course_name=<?php echo $read['Course']; ?>" target="_blank" rel="noopener noreferrer">Trainee List</a>
                     </td>
                  </tr>
                  <?php $count++;
                     } ?>
                  <?php
                         ...
                         $select_year = $_GET['Year'];
                         $schedule.= "SELECT Course,TopicCovered,StartDate,EndDate,Duration,FacultyOrganization,Fees,Feedback,FacultyName, EXTRACT(YEAR FROM StartDate) AS Year, EXTRACT(MONTH FROM StartDate) AS Month FROM `schedule` WHERE EndDate < CURDATE() AND Year(StartDate)='$select_year'  AND DeletedStatus='0' GROUP BY Course,TopicCovered,StartDate,EndDate,Duration,FacultyOrganization,Fees,Feedback,FacultyName";
