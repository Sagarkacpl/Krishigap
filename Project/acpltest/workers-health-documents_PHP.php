                        ...
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left">List Workers Health, Safety & Welfare
                                 Documents (Post Harvest Processing)
                              </h4>
                              ...
                              <div class="table-responsive">
                                 <table id="example" class="table table-striped table-borderless" style="width: 100% !important;">
                                    ...
                                    <tbody>
                                       <?php
                                          $query = mysqli_query($db,"SELECT * from workers_health_safety_welfare_documents_php where DeletedStatus='0' and WorkersHealthSafetyWelfareId='$_GET[id]' ORDER BY workers_health_safety_welfare_documents_id ASC");
                                          if($query){
                                       ...
                                       <tr>
                                          ...
                                          <td><a href="../Workers-Health_PHP/<?php echo $row['documents_name']; ?>" target="_blank"><i style="font-size: 22px;" class="ti-files btn-icon-prepend"></i></a></td>
                                          <td class="font-weight-medium">
                                             <a onclick="return confirm('Are you sure want to delete?')" href="workers-health-documents_delete_PHP.php?id=<?php echo $row['workers_health_safety_welfare_documents_id']; ?>&id1=<?php echo $_GET['id']; ?>&id2=<?php echo $_GET['id1'] ;?>" class="badge badge-danger"><i class="ti-trash btn-icon-prepend"></i> Delete</a>
                                          </td>
                                       </tr>
                                       <?php }} ?>
                                    </tbody>
