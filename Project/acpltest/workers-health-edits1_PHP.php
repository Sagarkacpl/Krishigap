<?php
   ...
   if (isset($_POST["StandardCategory"]) AND isset($_POST["GAPStandardWise"])) {
       ...
       $query2 = mysqli_query($db, "UPDATE `workers_health_safety_welfare_main_php` SET `StandardCategory`='$StandardCategory', `GAPStandardWise`='$GAPStandardWise' WHERE `workers_health_safety_welfare_main_id`='$workers_health_safety_welfare_main_id'");
       if ($query2) {
           foreach ($_POST["others"] as $key => $other) {
               ...
               if (!empty($YoutubeVideoLinks = $other['YoutubeVideoLink'])) {
                   foreach ($YoutubeVideoLinks as $YoutubeVideoLink) {
                       $query3 = mysqli_query($db, "INSERT INTO `workers_health_safety_welfare_youtube_php` (`workers_health_safety_welfare_youtube_id`, `WorkersHealthSafetyWelfareId`, `YoutubeTitleLink`, `DeletedStatus`, `CreatedDate`) VALUES (NULL, '$WorkersHealthSafetyWelfareId', '$YoutubeVideoLink', '0', current_timestamp());");
                   }
               }
               for ($i = 0;$i < count($_FILES["documents"]["name"][$key]);$i++) {
                   ...
                   if ($_FILES["documents"]["name"][$key][$i] != '') {
                       ...
                       if (move_uploaded_file($_FILES["documents"]["tmp_name"][$key][$i], "../Workers-Health_PHP/" . $documents)) {
           ...
           header("Location:workers-health-edits1_PHP.php?id=$workers_health_safety_welfare_main_id&msg=success");
       } else {
           header("Location:workers-health-edits1_PHP.php?id=$workers_health_safety_welfare_main_id&msg=fail");
       }
   }
   ?>
<!DOCTYPE html>
                     ...
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              ...
                              <div class="card-title float-right"><a href="workers-health-edit_PHP.php" class="btn btn-primary btn-sm">View List</a></div>
                                       ...
                                       <div class="col-6">
                                          <div class="form-group">
                                             ...
                                             <select name="StandardCategory" class="form-control" required="">
                                                ...
                                                <option <?php if ($row_edit['StandardCategory'] == 'Post Harvest Processing') {
                                                   echo "selected";
                                       ...
                                       <div class="col-6">
                                          <div class="form-group">
                                             ...
                                             <select name="GAPStandardWise" class="form-control" required="">
                                                <option value="">Please Select</option>
                                                <option <?php if($row_edit['GAPStandardWise'] == 'ISO 22000'){echo "selected";} ?> value="ISO 22000">ISO 22000</option>
                                                <option <?php if($row_edit['GAPStandardWise'] == 'FSSC 22000'){echo "selected";} ?> value="FSSC 22000">FSSC 22000</option>
                                                <option <?php if($row_edit['GAPStandardWise'] == 'BRC Global Standard Packaging 6'){echo "selected";} ?> value="BRC Global Standard Packaging 6">BRC Global Standard Packaging 6</option>
                                                <option <?php if($row_edit['GAPStandardWise'] == 'BRC Global Standard Food Safety 9'){echo "selected";} ?> value="BRC Global Standard Food Safety 9">BRC Global Standard Food Safety 9</option>
                                             </select>
                                          </div>
                                       </div>
                                    </div>
