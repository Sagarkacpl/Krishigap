...
$query_edit = mysqli_query($db, "SELECT * from plant_protection_products_tabs where plant_protection_products_tab_id = '$plant_protection_products_tab_id'");
$row_edit = mysqli_fetch_assoc($query_edit);

if (isset($_POST["Title"])) {
    $Title = $_POST["Title"];
    $TrainingModulesTitle = $_POST["TrainingModulesTitle"];
    $TrainingModulesLink = $_POST["TrainingModulesLink"];
    $Remark = $_POST["Remark"];
    $DocumentsSource = $_POST["DocumentsSource"];
    $SourceLink = $_POST["SourceLink"];
        $query = mysqli_query($db, "UPDATE `plant_protection_products_tabs` SET `Title`='$Title', `TrainingModulesTitle`='$TrainingModulesTitle', `TrainingModulesLink`='$TrainingModulesLink', `Remark`='$Remark', `DocumentsSource`='$DocumentsSource', `SourceLink`='$SourceLink' WHERE `plant_protection_products_tab_id`='$plant_protection_products_tab_id'");
        ...
        if ($query) {
          ...
          for ($i = 0;$i < count($_FILES["documents"]["name"]);$i++) {
                               ...
                               if ($_FILES["documents"]["name"][$i] != '') {
                                   ...
                                   if(move_uploaded_file($_FILES["documents"]["tmp_name"][$i], "../Plant-Protection-Products/" . $documents)){
            ...
            header("Location:plant-protection-documents-tabs-edit.php?id=$plant_protection_products_tab_id&id1=$_GET[id1]&msg=success");
        } else {
            header("Location:plant-protection-documents-tabs-edit.php?id=$plant_protection_products_tab_id&id1=$_GET[id1]&msg=fail");
        }
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="card-title float-right"><a href="plant-protection-documents-tabs.php?id=<?php echo $_GET['id1']; ?>" class="btn btn-primary btn-sm">View List</a></div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-12">
                                          <div class="form-group">
                                             ...
                                             <input value="<?php echo $row_edit['Title']; ?>" name="Title" type="text" class="form-control" id="" placeholder="Enter Document Title" required="">
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-12">
                                          <div class="form-group">
                                             ...
                                             <div class="input-group col-xs-12">
                                                <input class="file_input" id="file_input11" type="file" name="documents[]" style="display: block;
                                                   width: 100%;
                                                   height: 2.875rem;
