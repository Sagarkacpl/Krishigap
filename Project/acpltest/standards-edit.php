               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left">List Standards</h4>
                              <div class="card-title float-right"><a href="standards.php" class="btn btn-primary btn-sm" style="padding: 0.4rem 1rem;">Add New</a></div>
                                 ...
                                 <table id="example" class="table table-striped table-borderless" style="width: 100% !important;">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td><?php echo $row['OtherDocuments']; ?></td>
                                          <td><?php
                                             if($row['Crop'] == '00'){
                                              echo "ALL"; 
                                             }else{
                                             ...
                                             ?></td>
                                          <td><a href="standards-documents.php?id=<?php echo $row['standards_id']; ?>" target="_blank"><i style="font-size: 22px;" class="ti-files btn-icon-prepend"></i></a></td>
                                          <td><a href="standards-youtubes.php?id=<?php echo $row['standards_id']; ?>" target="_blank"><i style="font-size: 22px;" class="ti-files btn-icon-prepend"></i></a></td>
