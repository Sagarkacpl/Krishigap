...
if (isset($_POST["StandardCategory"]) AND isset($_POST["CropId"]) AND isset($_POST["GAPStandardWise"])) {
        $query2 = mysqli_query($db, "INSERT INTO `workers_health_safety_welfare_main` (`workers_health_safety_welfare_main_id`, `StandardCategory`, `GAPStandardWise`, `CropId`, `DeletedStatus`, `CreatedDate`) VALUES (NULL, '$_POST[StandardCategory]', '$_POST[GAPStandardWise]', '$_POST[CropId]', '0', current_timestamp());");
    ...
    header("Location:workers-health-add.php?msg=success");
}
else{
    header("Location:workers-health-add.php?msg=fail");
}
}
?>
<!DOCTYPE html>
               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                        <div class="card-body">
                           <h4 class="card-title float-left" style="margin-top: 7px;">Add Workers Health, Safety & Welfare</h4>
                           <div class="card-title float-right">        
                              <a href="workers-health-edit.php" class="btn btn-primary btn-sm">View List</a></div>
