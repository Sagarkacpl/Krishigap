<?php
   ...
   if (isset($_POST["PageName"]) && isset($_POST["type"]) && isset($_POST["DocumentsSource"]) && isset($_POST["SourceLink"])) {
       ...
       $query = mysqli_query($db, "INSERT INTO `mrls_laboratories_documents` (`mrls_laboratories_documentId`, `PageName`, `type`, `DocumentsSource`, `SourceLink`, `DeletedStatus`, `CreatedDate`) VALUES (NULL, '$PageName', '$type', '$DocumentsSource', '$SourceLink', '0', current_timestamp());");
       $mrls_laboratories_documentId = $db->insert_id;
       ...
       if ($query) {
           header("Location:mrls-laboratories-Documents-add.php?msg=success");
       } else {
           header("Location:mrls-laboratories-Documents-add.php?msg=fail");
       }
   } ?>
<!DOCTYPE html>
<html lang="en">
               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left" style="margin-top: 7px;">Add MRLs/Laboratories Documents</h4>
                              <div class="card-title float-right">        
                                 <a href="mrls-laboratories-Documents-list.php" class="btn btn-primary btn-sm">View List</a>
                              </div>
                              <div class="clearfix"></div>
                              <?php if ($_GET['msg'] == 'faile') { ?>
                              <div class="row">
                                 <div class="col-lg-12">
                              ...
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-danger">
                                          <button class="close" type="button" data-dismiss="alert">×</button>MRLs/Laboratories Document details not saved.
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-success">
                                          <button class="close" type="button" data-dismiss="alert">×</button>MRLs/Laboratories Document details successfully saved.
                                       </div>
                                    </div>
                                 </div>
                              </div>
