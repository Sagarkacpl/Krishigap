                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card mt-3">
                                <div class="card-body">
                                    <h4 class="card-title float-left">Schedule Date
                                    </h4>
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table table-striped table-centered mb-0"
                                            ...
                                            <tbody>
                                                <?php
                                                $select = "SELECT * FROM `skilldevelopmenthistory`";
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: justify;">
                                                        <?php echo $read['SkillDevelopmentHistory']; ?>
                                                    </td>

                                                    <td>
                                                        <a onclick="return confirm('Are you sure want to edit?')"
                                                            href="SkillDevelopmentHistory-edit.php?id=<?php echo $read['Id']; ?>"
