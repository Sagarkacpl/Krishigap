...
$query = mysqli_query($db, "UPDATE `plant_protection_products` SET DeletedStatus='1' where plant_protection_product_id ='$plant_protection_product_id'");
$query1 = mysqli_query($db, "UPDATE `plant_protection_documents` SET DeletedStatus='1' where plant_protection_product_id ='$plant_protection_product_id'");
$query2 = mysqli_query($db, "SELECT * FROM `plant_protection_products_tabs` WHERE plant_protection_product_id ='$plant_protection_product_id'");
   while ($row2 = mysqli_fetch_array($query2)) {
   $plant_protection_products_tab_id = $row2['plant_protection_products_tab_id'];
...
if ($query) {
    header("Location:plant-protection-edit.php?msg=successd");
} else {
    header("Location:plant-protection-edit.php?msg=faild");
} ?>