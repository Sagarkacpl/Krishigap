            ...
            <div class="content-wrapper">
               <div class="row">
                  <div class="col-12 grid-margin stretch-card">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="card-title float-left" style="margin-top: 7px;">Add Food Safety Standards</h4>
                           <div class="card-title float-right">        
                              <a href="Food-Safety-Standards-add-edit.php" class="btn btn-primary btn-sm">View List</a>
                           </div>
