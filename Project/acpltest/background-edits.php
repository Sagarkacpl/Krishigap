...
$query_edit = mysqli_query($db, "SELECT * from background where background_id = '$background_id'");
...
if (isset($_POST["GAPStandardWise"]) && isset($_POST["Remark"]) && isset($_POST["DocumentsSource"])) {
    ...
    $DocumentsSource = mysqli_real_escape_string($db, $_POST["DocumentsSource"]);
     ...
     for ($i = 0;$i < count($_FILES["documents"]["name"]);$i++) {
        ...
        $query = mysqli_query($db, "UPDATE `background` SET  `GAPStandardWise`='$GAPStandardWise', `Remark`='$Remark', `DocumentsSource`='$DocumentsSource' WHERE `background_id`='$background_id'");
        if ($query) {
            header("Location:background-edits.php?id=$background_id&msg=success");
        } else {
            header("Location:background-edits.php?id=$background_id&msg=fail");
        }
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-success">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Background details successfully edited.
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-danger">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Background details not edited.
                                       </div>
                                    </div>
                                 </div>
                              </div>
