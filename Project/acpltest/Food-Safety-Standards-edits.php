<?php
   ...
   $query_edit = mysqli_query($db, "SELECT * from food_safety_standards where FoodSafetyStandardsId  = '$FoodSafetyStandardsId'");
   ...
   if (isset($_POST["StandardCategory"]) && isset($_POST["GAPStandardWise"]) && isset($_POST["Crop"]) && isset($_POST["User"]) && isset($_POST["Documents"]) && isset($_POST["SourceLink"])) {
       ...
       $SourceLink = mysqli_real_escape_string($db, $_POST["SourceLink"]);
           $query = mysqli_query($db, "UPDATE `food_safety_standards` SET `StandardCategory`='$StandardCategory', `GAPStandardWise`='$GAPStandardWise', `Crop`='$Crop', `Documents`='$Documents', `User`='$User', `Remark`='$Remark', `DocumentsSource`='$DocumentsSource', `SourceLink`='$SourceLink' WHERE `FoodSafetyStandardsId`='$FoodSafetyStandardsId'");
           if ($query) {
            for ($i = 0;$i < count($_FILES["documents"]["name"]);$i++) {
               ...
               header("Location:Food-Safety-Standards-edits.php?id=$FoodSafetyStandardsId&msg=success");
           } else {
               header("Location:Food-Safety-Standards-edits.php?id=$FoodSafetyStandardsId&msg=fail");
           }
   } ?>
<!DOCTYPE html>
<html lang="en">
               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left">Edit Food Safety Standards</h4>
                              <div class="card-title float-right"><a href="Food-Safety-Standards-add-edit.php" class="btn btn-primary btn-sm">View List</a></div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-success">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Food Safety Standards details successfully edited.
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-danger">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Food Safety Standards details not edited..
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                       ...
                                       <div class="col-4">
                                          <div class="form-group">
                                             ...
                                             <select name="Documents" class="form-control" required="">
                                                <option value="">Please Select</option>
                                                <option <?php if($row_edit['Documents'] == 'Standard'){echo "selected";} ?> value="Standard">Standard</option>
                                                <option <?php if($row_edit['Documents'] == 'Quality Manual'){echo "selected";} ?> value="Quality Manual">Quality Manual</option>
                                                <option <?php if($row_edit['Documents'] == 'Procedures'){echo "selected";} ?> value="Procedures">Procedures</option>
                                                <option <?php if($row_edit['Documents'] == 'Risk Assessment'){echo "selected";} ?> value="Risk Assessment">Risk Assessment</option>
                                                <option <?php if($row_edit['Documents'] == 'Records'){echo "selected";} ?> value="Records">Records</option>
                                                <option <?php if($row_edit['Documents'] == 'Others'){echo "selected";} ?> value="Others">Others</option>
                                             </select>
                                          </div>
                                       </div>
                                       <div class="col-12">
