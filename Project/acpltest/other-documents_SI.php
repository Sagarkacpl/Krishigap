               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left">List Others Documents (Sustainable Initiatives)</h4>
                              ...
                              <div class="table-responsive">
                                 <table id="example" class="table table-striped table-borderless" style="width: 100% !important;">
                                    ...
                                    <tbody>
                                       <?php
                                          $query = mysqli_query($db,"SELECT * from others_documents_si where DeletedStatus='0' and OthersId='$_GET[id]' ORDER BY others_documents_id ASC");
                                          if($query){
                                       ...
                                       <tr>
                                          ...
                                          <td><a href="../Others_SI/<?php echo $row['documents_name']; ?>" target="_blank"><i style="font-size: 22px;" class="ti-files btn-icon-prepend"></i></a></td>
                                          <td class="font-weight-medium">
                                             <a onclick="return confirm('Are you sure want to delete?')" href="other-documents_delete_SI.php?id=<?php echo $row['others_documents_id']; ?>&id1=<?php echo $_GET['id']; ?>" class="badge badge-danger"><i class="ti-trash btn-icon-prepend"></i> Delete</a>
                                          </td>
                                       </tr>
                                       <?php }} ?>
                                    </tbody>
