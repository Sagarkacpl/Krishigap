<?php
   ...
   if (isset($_POST["StandardCategory"]) && isset($_POST["GAPStandardWise"]) && isset($_POST["User"]) && isset($_POST["Documents"]) && isset($_POST["SourceLink"])) {
       ...
       $query = mysqli_query($db, "INSERT INTO `food_safety_standards_si` (`FoodSafetyStandardsId`, `StandardCategory`, `GAPStandardWise`, `Documents`, `User`, `sort`, `Remark`, `DocumentsSource`, `SourceLink`, `DeletedStatus`, `CreatedDate`) VALUES (NULL, '$StandardCategory', '$GAPStandardWise', '$Documents', '$User', '0', '$Remark', '$DocumentsSource', '$SourceLink', '0', current_timestamp());");
       ...
       if ($query) {
           ...
           header("Location:Food-Safety-Standards-add_SI.php?msg=success");
       } else {
           header("Location:Food-Safety-Standards-add_SI.php?msg=fail");
       }
   } ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="content-wrapper">
               <div class="row">
                  <div class="col-12 grid-margin stretch-card">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="card-title float-left" style="margin-top: 7px;">Add Standards (Sustainable Initiatives)</h4>
                           <div class="card-title float-right">        
                              <a href="Food-Safety-Standards-add-edit_SI.php" class="btn btn-primary btn-sm">View List</a>
                           </div>
                              ...
                              <div class="col-lg-12">
                                 <div class="bs-component">
                                    <div class="alert alert-dismissible alert-danger">
                                       <button class="close" type="button" data-dismiss="alert">×</button>Standards details already exist.
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="bs-component">
                                    <div class="alert alert-dismissible alert-danger">
                                       <button class="close" type="button" data-dismiss="alert">×</button>Standards details not saved.
                                    </div>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="col-lg-12">
                                 <div class="bs-component">
                                    <div class="alert alert-dismissible alert-success">
                                       <button class="close" type="button" data-dismiss="alert">×</button>Standards details successfully saved.
                                    </div>
                                 </div>
                              </div>
                           </div>
                                    ...
                                    <div class="col-4">
                                       <div class="form-group">
                                          ...
                                          <select name="GAPStandardWise" class="form-control" required="">
                                             ...
                                             <option value="ISO 45001 OH&S Mgt Systems">ISO 45001 OH&S Mgt Systems</option>
                                             <option value="SA 8000- Social Accountability">SA 8000- Social Accountability</option>
