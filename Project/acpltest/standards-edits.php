...
$query_edit = mysqli_query($db, "SELECT * from standards where standards_id  = '$standards_id'");
...
if (isset($_POST["OtherDocuments"]) && isset($_POST["GAPStandardWise"]) && isset($_POST["Crop"]) && isset($_POST["Remark"]) && isset($_POST["DocumentsSource"])) {
    ...
    for ($i = 0;$i < count($_FILES["documents"]["name"]);$i++) {
        ...
        $query = mysqli_query($db, "UPDATE `standards` SET  `GAPStandardWise`='$GAPStandardWise',`OtherDocuments`='$OtherDocuments', `Crop`='$Crop', `Remark`='$Remark', `DocumentsSource`='$DocumentsSource' WHERE `standards_id`='$standards_id'");
        if ($query) {
            header("Location:standards-edits.php?id=$standards_id&msg=success");
        } else {
            header("Location:standards-edits.php?id=$standards_id&msg=fail");
        }
               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left">Edit Standards</h4>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-success">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Standard details successfully edited.
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-danger">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Standard details not edited.
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <select name="OtherDocuments" class="form-control" required="">
                                             <option value="">Please Select</option>
                                             <option <?php if($row_edit['OtherDocuments'] == 'Quality Manual'){echo "selected";} ?> value="Quality Manual">Quality Manual</option>
                                             <option <?php if($row_edit['OtherDocuments'] == 'Procedures'){echo "selected";} ?> value="Procedures">Procedures</option>
                                             <option <?php if($row_edit['OtherDocuments'] == 'Work Instructions'){echo "selected";} ?> value="Work Instructions">Work Instructions</option>
                                             <option <?php if($row_edit['OtherDocuments'] == 'Records'){echo "selected";} ?> value="Records">Records</option>
                                             <option <?php if($row_edit['OtherDocuments'] == 'Videos'){echo "selected";} ?> value="Videos">Videos</option>
                                          </select>
                                       </div>
                                       </div>
                                       <div class="col-4">
