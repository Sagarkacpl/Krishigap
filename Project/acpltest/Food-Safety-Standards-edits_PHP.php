<?php
   ...
   $query_edit = mysqli_query($db, "SELECT * from food_safety_standards_php where FoodSafetyStandardsId  = '$FoodSafetyStandardsId'");
   ...
   if (isset($_POST["StandardCategory"]) && isset($_POST["GAPStandardWise"]) && isset($_POST["User"]) && isset($_POST["Documents"]) && isset($_POST["SourceLink"])) {
       ...
       $query = mysqli_query($db, "UPDATE `food_safety_standards_php` SET `StandardCategory`='$StandardCategory', `GAPStandardWise`='$GAPStandardWise', `Documents`='$Documents', `User`='$User', `Remark`='$Remark', `DocumentsSource`='$DocumentsSource', `SourceLink`='$SourceLink' WHERE `FoodSafetyStandardsId`='$FoodSafetyStandardsId'");
       if ($query) {
           ...
           header("Location:Food-Safety-Standards-edits_PHP.php?id=$FoodSafetyStandardsId&msg=success");
       } else {
           header("Location:Food-Safety-Standards-edits_PHP.php?id=$FoodSafetyStandardsId&msg=fail");
       }
   } ?>
<!DOCTYPE html>
<html lang="en">
               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left">Edit Food Safety Standards (Post Harvest Processing)</h4>
                              <div class="card-title float-right"><a href="Food-Safety-Standards-add-edit_PHP.php" class="btn btn-primary btn-sm">View List</a></div>
                                       ...
                                       <div class="col-4">
                                          <div class="form-group">
                                             ...
                                             <select name="GAPStandardWise" class="form-control" required="">
                                                ...
                                                <option <?php if ($row_edit['GAPStandardWise'] == 'BRC Global Standard Packaging 6') {
                                                   echo "selected";
                                                   } ?> value="BRC Global Standard Packaging 6">BRC Global Standard Packaging 6</option>
                                                   
                                                   <option <?php if ($row_edit['GAPStandardWise'] == 'BRC Global Standard Food Safety 9') {
                                                   echo "selected";
