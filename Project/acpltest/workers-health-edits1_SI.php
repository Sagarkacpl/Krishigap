<?php
   ...
   if (isset($_POST["StandardCategory"]) AND isset($_POST["GAPStandardWise"])) {
       ...
       $query2 = mysqli_query($db, "UPDATE `workers_health_safety_welfare_main_si` SET `StandardCategory`='$StandardCategory', `GAPStandardWise`='$GAPStandardWise' WHERE `workers_health_safety_welfare_main_id`='$workers_health_safety_welfare_main_id'");
       if ($query2) {
           ...
           header("Location:workers-health-edits1_SI.php?id=$workers_health_safety_welfare_main_id&msg=success");
       } else {
           header("Location:workers-health-edits1_SI.php?id=$workers_health_safety_welfare_main_id&msg=fail");
       }
   }
   ?>
<!DOCTYPE html>
               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left">Edit Workers Health, Safety & Welfare (Sustainable Initiatives)</h4>
                              <div class="card-title float-right"><a href="workers-health-edit_SI.php" class="btn btn-primary btn-sm">View List</a></div>
                                       ...
                                       <div class="col-6">
                                          <div class="form-group">
                                             ...
                                             <select name="GAPStandardWise" class="form-control" required="">
                                                ...
                                                <option <?php if($row_edit['GAPStandardWise'] == 'Fair Trade Certified'){echo "selected";} ?> value="Fair Trade Certified">Fair Trade Certified</option>
...
<!-- 
                                                ...
                                                <option <?php if($row_edit['GAPStandardWise'] == 'BRC Global'){echo "selected";} ?> value="BRC Global">BRC Global</option> -->
                                             </select>
                                          </div>
                                       </div>
                                    </div>
