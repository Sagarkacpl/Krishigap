...
if (isset($_POST["GAPStandardWise"]) && isset($_POST["DocumentsTitle"]) && isset($_POST["VideoTitle"]) && isset($_POST["YoutubeVideoLink"]) && isset($_POST["TrainingModulesTitle"]) && isset($_POST["TrainingModulesLink"]) && isset($_POST["Remark"]) && isset($_POST["DocumentsSource"]) && isset($_POST["SourceLink"])) {
    ...
    $SourceLink = mysqli_real_escape_string($db, $_POST["SourceLink"]);
        $query = mysqli_query($db, "INSERT INTO `internal_audit_php` (`InternalAuditID`, `GAPStandardWise`, `DocumentsTitle`, `Document`, `VideoTitle`, `YoutubeVideoLink`, `TrainingModulesTitle`, `TrainingModulesLink`, `sort`, `Remark`, `DocumentsSource`, `SourceLink`, `DeletedStatus`, `CreatedDate`) VALUES (NULL, '$GAPStandardWise', '$DocumentsTitle', '', '$VideoTitle', '$YoutubeVideoLink', '$TrainingModulesTitle', '$TrainingModulesLink', '0', '$Remark', '$DocumentsSource', '$SourceLink', '0', current_timestamp());");
        $InternalAuditID = $db->insert_id;
        ...
        if ($query) {
            header("Location:internal-audit-add_PHP.php?msg=success");
        } else {
            header("Location:internal-audit-add_PHP.php?msg=fail");
        }
} ?>
<!DOCTYPE html>
<html lang="en">
               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                        <div class="card-body">
                           <h4 class="card-title float-left" style="margin-top: 7px;">Add Internal Audit</h4>
                           <div class="card-title float-right">        
                              <a href="internal-audit-edit_PHP.php" class="btn btn-primary btn-sm">View List</a></div>
