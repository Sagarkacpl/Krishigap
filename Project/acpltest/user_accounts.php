            ...
            <div class="content-wrapper">
               <div class="row">
                  <div class="col-12 grid-margin stretch-card">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="card-title float-left">Contact Us
                           </h4>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-danger">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Crops
                                          Standards details not deleted..
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="table-responsive">
                              <table id="example" class="table table-striped table-borderless"
                                 ...
                                 <tbody>
                                    <?php
                                    $contact_us = "SELECT * FROM `partial_users` WHERE DeletedStatus='0' ORDER BY UserID DESC";
                                    $execute = mysqli_query($db, $contact_us);
                                    $count = 1;
                                    while ($read = mysqli_fetch_assoc($execute)) {
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <p>
                                                <?php echo $read['Website']; ?>
                                             </p>
                                          </td>
                                          <td>
                                             <p>
                                                <?php echo $read['Business_Activity']; ?>
                                             </p>
                                          </td>
                                          <td>
                                              <p>
                                                  <?php 
                                                  $date = date_create($read['Created_at']);
                                          ...
                                          <!--      class="badge badge-danger"><i class="ti-trash btn-icon-prepend"></i>-->
                                          <!--      Delete</a>-->
                                          <!--</td>-->
                                       </tr>
                                       <?php $count++;
