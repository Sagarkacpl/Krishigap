...
if (isset($_POST["GAPStandardWise"]) && isset($_POST["Crop"]) && isset($_POST["DocumentsTitle"]) && isset($_POST["VideoTitle"]) && isset($_POST["YoutubeVideoLink"]) && isset($_POST["TrainingModulesTitle"]) && isset($_POST["TrainingModulesLink"]) && isset($_POST["Remark"]) && isset($_POST["DocumentsSource"]) && isset($_POST["SourceLink"])) {
    ...
    $SourceLink = mysqli_real_escape_string($db, $_POST["SourceLink"]);
        $query = mysqli_query($db, "INSERT INTO `internal_audit` (`InternalAuditID`, `GAPStandardWise`, `Crop`, `DocumentsTitle`, `Document`, `VideoTitle`, `YoutubeVideoLink`, `TrainingModulesTitle`, `TrainingModulesLink`, `sort`, `Remark`, `DocumentsSource`, `SourceLink`, `DeletedStatus`, `CreatedDate`) VALUES (NULL, '$GAPStandardWise', '$Crop', '$DocumentsTitle', '', '$VideoTitle', '$YoutubeVideoLink', '$TrainingModulesTitle', '$TrainingModulesLink', '0', '$Remark', '$DocumentsSource', '$SourceLink', '0', current_timestamp());");
        ...
        if ($query) {
            header("Location:internal-audit-add.php?msg=success");
        } else {
            header("Location:internal-audit-add.php?msg=fail");
        }
} ?>
<!DOCTYPE html>
<html lang="en">
                     ...
                     <div class="col-12 grid-margin stretch-card">
                        ...
                        <div class="card-body">
                           ...
                           <div class="card-title float-right">        
                              <a href="internal-audit-edit.php" class="btn btn-primary btn-sm">View List</a></div>
