<?php
   ...
   $id=$_GET['id'];
   $edit = "SELECT * FROM `most_popular_course` WHERE Id='$id'";
   ...
   if(isset($_POST['save']))
   {
       ...
       $insert = "UPDATE `most_popular_course` SET popular_course='$story' WHERE Id='$id'";
       $execute = mysqli_query($db,$insert);
       if($execute == TRUE)
       {
            echo "<script>alert('Successfully Update')</script>";
            echo "<script>window.location.href='most-popular.php'</script>";
       }
                              ...
                              <div class="expert-repeat" style="padding-top: 10px;">
                                 <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea class="form-control" id="editor1" rows="4" name="MostPopularCourse"><?php echo $fetch['popular_course']; ?></textarea>
                                    </div>
                                 </div>
                                 <div class="col-12">
