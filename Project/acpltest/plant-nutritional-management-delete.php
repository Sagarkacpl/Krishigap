...
$query = mysqli_query($db, "UPDATE `plant_nutritional_management` SET DeletedStatus='1' where plant_nutritional_management_id ='$plant_nutritional_management_id'");

$query3 = mysqli_query($db, "SELECT * FROM `plant_nutritional_management_tabs` WHERE plant_nutritional_management_id ='$plant_nutritional_management_id'");
   while ($row3 = mysqli_fetch_array($query3)) {
   $plant_nutritional_management_tab_id = $row3['plant_nutritional_management_tab_id'];

  $query4 = mysqli_query($db, "UPDATE `plant_nutritional_management_tabs` SET DeletedStatus='1' where plant_nutritional_management_tab_id ='$plant_nutritional_management_tab_id'");
...
if ($query) {
    header("Location:plant-nutritional-management-edit.php?msg=successd");
} else {
    header("Location:plant-nutritional-management-edit.php?msg=faild");
} ?>