                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title float-left">Enquiries
                                    </h4>
                                                ...
                                                <div class="bs-component">
                                                    <div class="alert alert-dismissible alert-danger">
                                                        <button class="close" type="button"
                                                            data-dismiss="alert">×</button>Crops Standards details not
                                                        deleted..
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="bs-component">
                                                    <div class="alert alert-dismissible alert-success">
                                                        <button class="close" type="button"
                                                            data-dismiss="alert">×</button>Crops Standards
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table table-striped table-borderless"
                                            ...
                                            <tbody>
                                                <?php
                                                $feedback = "SELECT * FROM `training_module_enquiry`";
                                                $execute = mysqli_query($db, $feedback);
                                                $count = 1;
                                                while ($read = mysqli_fetch_assoc($execute)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p>
                                                                <?php echo $read['CourseInteresetd']; ?>
                                                            </p>
                                                        </td>
                                                        <td>
                                                            <p>
                                                                <?php echo $read['Remark']; ?>
                                                            </p>
                                                        </td>
                                                        <td>
                                                            <p>
                                              ...
                                              <p>
                                                  <?php 
                                                  $date = date_create($read['Created_Date']);
                                                  ...
                                                  ?>
                                                        ...
                                                        <td class="font-weight-medium">
                                                            <a onclick="return confirm('Are you sure want to delete?')"
                                                                href="#" class="badge badge-danger"><i
