   ...
   <body>
      ...
      <div class="container-xxl py-5" style="padding-top: 0rem !important;padding-bottom: 0rem !important;">
         ...
         <ul class="text-justify">
            <li>In this section, we have covered India's Good Agricultural Practices, Global G.A.P, and Organic Certification NPOP & NOP. Standard-wise Quality Manuals, Procedures, Farmers' records (in local anguages), Information on Plant Protection Products, Package of practices, Harvest, and Postharvest standards, inspectors' qualifications, Workers' Health and Welfare, and Government promotion schemes are available.</li>
            <li> You can search for the required information standard-wise by clicking on the respective icons.</li>
            <li> Additionally, we offer skill development programs on the implementation of these standards and the qualification of inspectors conducted digitally.</li>
         </ul>
