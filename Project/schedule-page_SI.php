...
<body>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <form action="schedule-page_SI.php" method="post">
                <div class="row mt-5">
                    <div class="col-md-4">
                        <h5>Course Type</h5>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-floating">
                            <select name="Month" class="form-control" required="">
									...
									<?php
									 $db_month = "SELECT  MONTH(StartDate) `Month` FROM schedule_SI WHERE EndDate < CURDATE() GROUP BY MONTH(StartDate)";
            ...
            <div class="row g-5 mt-5">
                ...
                <?php
                $select = "SELECT * FROM `schedule_SI` WHERE EndDate > CURRENT_DATE AND DeletedStatus='0'";
                ...
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.3s">
                    <div class="schedule-re">
                        ...
                        <li><strong>Course</strong></li>
                            ...
                            <li><a href="CourseDetails_SI.php">View Course Details</a> </li>
                           
                            <li><a href="CourseAmountPay_SI.php" class="btn btn-outline-success mt-3">Register</a></li>
                        </ul>
                    </div>
                </div>
                <?php } ?>
