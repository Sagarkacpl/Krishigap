<?php
   ...
   include "most_visited_page.php";
      $query = mysqli_query($db, "SELECT * from mrls_laboratories_documents WHERE PageName = 'Plant Protection Products' AND DeletedStatus='0' AND type='Laboratories' ORDER BY mrls_laboratories_documentId ASC");
   ?>
<!DOCTYPE html>
<html lang="en">
    <head>
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-10 text-center">
                  <h1 class="display-3 text-white animated slideInDown" style="font-size: 45px;">Plant Protection Products Laboratories Documents</h1>
               ...
               <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                  <div class="row g-3">
                     ...
                     <div class="col-md-2">
                        ...
                        <a href="plant-protection-laboratories-document-pdf.php?doc=<?php echo $row31['mrls_laboratories_document_file_id']; ?>" target="_blank"><i style="font-size: 30px;" class="ti-files btn-icon-prepend"></i></a>
                        <?php }else{?>
