 ...
 //   include "most_visited_page.php";
   if ($_GET['gsw'] != '') {
       ...
       if ($_GET['gsw'] == 'BRCGlobalStandardFoodSafety9') {
        ...
        $query = mysqli_query($db, "SELECT * from related_documents WHERE PageName = 'Food Safety Standards PHP' AND GAPStandardWise = '$GETgsw' AND DeletedStatus='0' ORDER BY RelatedDocumentId ASC");
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-10 text-center">
                  <h1 class="display-3 text-white animated slideInDown" style="font-size: 45px;">Food Safety Standards Related Documents (Post Harvest Processing)</h1>
            ...
            <div class="col-md-4">
               ...
               <div class="form-floating">
                  <select id="gswselector" name="gsw" class="form-control" required="" onchange="if (this.value) window.location.href=this.value">
                     <option value="food-safety-standards-related-documents_PHP.php">All</option>
                                 <option <?php if ($_GET['gsw'] == 'ISO22000') {echo "selected";} ?> value="food-safety-standards-related-documents_PHP.php?gsw=ISO22000">ISO 22000</option>
                                 <option <?php if ($_GET['gsw'] == 'FSSC22000') {echo "selected";} ?> value="food-safety-standards-related-documents_PHP.php?gsw=FSSC22000">FSSC 22000</option>
                                 <option <?php if ($_GET['gsw'] == 'BRCGlobalStandardPackaging6') {echo "selected";} ?> value="food-safety-standards-related-documents_PHP.php?gsw=BRCGlobalStandardPackaging6">BRC Global Standard Packaging 6</option>
                                 <option <?php if ($_GET['gsw'] == 'BRCGlobalStandardFoodSafety9') {echo "selected";} ?> value="food-safety-standards-related-documents_PHP.php?gsw=BRCGlobalStandardFoodSafety9">BRC Global Standard Food Safety 9</option>
                     </select>
               </div>
            </div>
            <div class="row g-4">
