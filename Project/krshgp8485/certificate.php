                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card mt-3">
                                <div class="card-body">
                                    <h4 class="card-title float-left">Certificate List
                                    </h4>
                                    <div class="card-title float-right">
                                        <a href="add_certificate.php" class="btn btn-primary btn-sm"
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="table table-striped table-centered mb-0"
                                            ...
                                            <tbody>
                                                <?php
                                                $select = "SELECT * FROM `certificates` WHERE DeletedStatus='0'";
                                                ...
                                                while ($read = mysqli_fetch_assoc($execute)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p>
                                                                <?php echo $read['Trainee_Name']; ?>
                                                            </p>
                                                        </td>
                                                        <td>
                                                            <p><a href="certificates/<?php echo $read['Trainee_Certificate']; ?>"
                                                                    target="_blank"><img src="../img/pdf.png" alt=""
                                                                        style="width: 36px;height: 44px;border-radius: 0%!important;"></a>
                                                            </p>
                                                        </td>
                                                        <td>
                                                            <p>
                                                                <a onclick="return confirm('Are you sure want to edit?')"
                                                                    href="edit_certificate.php?edit=<?php echo $read['Id']; ?>"
                                                                    class="badge badge-success"><i
                                                                        class="ti-pencil btn-icon-prepend"></i> Edit</a>

                                                                <a onclick="return confirm('Are you sure want to delete?')"
                                                                    href="delete_certificate.php?id=<?php echo $read['Id']; ?>"
