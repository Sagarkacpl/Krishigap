<?php
   ...
   if (isset($_POST["StandardCategory"]) && isset($_POST["GAPStandardWise"]) && isset($_POST["Crop"]) && isset($_POST["User"])) {
       ...
       $SourceLink = mysqli_real_escape_string($db, $_POST["SourceLink"]);
           $query = mysqli_query($db, "INSERT INTO `harvesting` (`HarvestingId`, `StandardCategory`, `GAPStandardWise`, `Crop`, `User`, `Remark`, `DocumentsSource`, `SourceLink`, `DeletedStatus`, `CreatedDate`) VALUES (NULL, '$StandardCategory', '$GAPStandardWise', '$Crop', '$User', '$Remark', '$DocumentsSource', '$SourceLink', '0', current_timestamp());");
           $HarvestingId = $db->insert_id;
           ...
           if ($query) {
               header("Location:Harvesting-add.php?msg=success");
           } else {
               header("Location:Harvesting-add.php?msg=fail");
           }
   } ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="content-wrapper">
               <div class="row">
                  <div class="col-12 grid-margin stretch-card">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="card-title float-left" style="margin-top: 7px;">Add Harvesting</h4>
                           <div class="card-title float-right">        
                              <a href="Harvesting-add-edit.php" class="btn btn-primary btn-sm">View List</a></div>
                              ...
                              <div class="col-lg-12">
                                 <div class="bs-component">
                                    <div class="alert alert-dismissible alert-danger">
                                       <button class="close" type="button" data-dismiss="alert">×</button>Harvesting details already exist.
                                    </div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="bs-component">
                                    <div class="alert alert-dismissible alert-danger">
                                       <button class="close" type="button" data-dismiss="alert">×</button>Harvesting details not saved.
                                    </div>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="col-lg-12">
                                 <div class="bs-component">
                                    <div class="alert alert-dismissible alert-success">
                                       <button class="close" type="button" data-dismiss="alert">×</button>Harvesting details successfully saved.
                                    </div>
                                 </div>
                              </div>
                           </div>
                                       ...
                                       <div class="form-group row">
                                          <div class="col-sm-6">
                                             <div class="form-check">
                                                ...
                                                <input type="radio" class="form-check-input" name="User" id="" value="Farmer Producer Group/Exporter" required="">
