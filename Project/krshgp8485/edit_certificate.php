<?php
   ...
   $id = $_GET['edit'];
   $certi = "SELECT * FROM `certificates` WHERE Id='$id'";
   $exe = mysqli_query($db,$certi);
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title float-left" style="margin-top: 7px;">Edit Certificate List</h4>
                              ...
                              if($msg == 'success'){?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="TraineeName" class="form-control" placeholder="Trainee Name" required="" value="<?php echo $read['Trainee_Name']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <a href="certificates/<?php echo $read['Trainee_Certificate']; ?>" target="_blank"><img src="../img/pdf.png" alt="" style="width: 36px;height: 44px;border-radius: 0%!important;"></a>
                                                    </div>
                                                </div>
                                    ...
                                    <?php
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            if($certificates == "")
                                            {
                                                $event =$read['Trainee_Certificate'];
                                            }
                                            else{
                                                $event = $certificates;
                                            }
                                            $file_type = pathinfo($event, PATHINFO_EXTENSION);
                                            if ($file_type == 'pdf' || $file_type == 'doc') {
                                                move_uploaded_file($certificates_tmp,"certificates/".basename($certificates));
                                                        
                                                $insert = "UPDATE `certificates` SET Trainee_Name='$TraineeName',Trainee_Certificate='$event' WHERE Id='$id'";
                                                ...
                                                {
                                                    echo "<script>alert('Certificate Can not Update')</script>";
                                                }
                                                ...
                                                text-align: center;">
                                                <strong>Sorry!</strong> Please upload only pdf and document file.
