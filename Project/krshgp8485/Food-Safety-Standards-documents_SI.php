               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left">List Standards Documents (Sustainable Initiatives)</h4>
                              <div class="card-title float-right"><a href="Food-Safety-Standards-add-edit_SI.php" class="btn btn-primary btn-sm" style="padding: 0.4rem 1rem;">Back</a></div>
                              ...
                              <div class="table-responsive">
                                 <table id="example" class="table table-striped table-borderless" style="width: 100% !important;">
                                    ...
                                    <tbody>
                                       <?php
                                          $query = mysqli_query($db, "SELECT * from food_safety_standards_documents_si where DeletedStatus='0' and FoodSafetyStandardsId='$_GET[id]' ORDER BY food_safety_standards_documents_id ASC");
                                          if ($query) {
                                       ...
                                       <tr>
                                          ...
                                          <td><a href="../Food-Safety-Standards_SI/<?php echo $row['documents_name']; ?>"><i style="font-size: 22px;" class="ti-files btn-icon-prepend"></i></a></td>
                                          <td class="font-weight-medium">
                                             <a onclick="return confirm('Are you sure want to delete?')" href="Food-Safety-Standards-documents_delete_SI.php?id=<?php echo $row['food_safety_standards_documents_id']; ?>&id1=<?php echo $_GET['id']; ?>" class="badge badge-danger"><i class="ti-trash btn-icon-prepend"></i> Delete</a>
                                          </td>
                                       </tr>
                                       <?php
                                          }
