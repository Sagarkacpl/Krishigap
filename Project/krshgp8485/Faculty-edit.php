<?php
   ...
   $id=$_GET['id'];
   $edit = "SELECT * FROM `faculty` WHERE Id='$id'";
   ...
   if(isset($_POST['save']))
   {
       ...
       $insert = "UPDATE `faculty` SET OurFaculty='$story' WHERE Id='$id'";
                              ...
                              <div class="expert-repeat" style="padding-top: 10px;">
                                 <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea class="form-control" id="editor1" rows="4" name="MostPopularCourse"><?php echo $fetch['OurFaculty']; ?></textarea>
                                    </div>
                                 </div>
                                 <div class="col-12">
