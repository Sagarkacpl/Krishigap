                                    ...
                                    <?php
                                        if(isset($_POST['submit']))
                                        {
                                            ...
                                            if ($file_type == 'pdf' || $file_type == 'doc') {
                                                ...
                                                $insert = "INSERT INTO `certificates` SET Trainee_Name='$TraineeName',Trainee_Certificate='$certificates', DeletedStatus='0'";
                                                $execute = mysqli_query($db,$insert);
                                                if($execute == TRUE)
                                                {
                                                    echo "<script>alert('Certificate Upload Successfully')</script>";
