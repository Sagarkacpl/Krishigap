<?php
   ...
   $id=$_GET['id'];
   $edit = "SELECT * FROM `skilldevelopmenthistory` WHERE Id='$id'";
   $edit_exe = mysqli_query($db,$edit);
   $fetch = mysqli_fetch_assoc($edit_exe);
   if(isset($_POST['save']))
   {
       $story = $_POST['MostPopularCourse'];

       $insert = "UPDATE `skilldevelopmenthistory` SET SkillDevelopmentHistory='$story' WHERE Id='$id'";
       $execute = mysqli_query($db,$insert);
       if($execute == TRUE)
       {
            echo "<script>alert('Successfully Update')</script>";
            echo "<script>window.location.href='SkillDevelopmentHistory.php'</script>";
       }
                              ...
                              <div class="expert-repeat" style="padding-top: 10px;">
                                 <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea class="form-control" id="editor1" rows="4" name="MostPopularCourse"><?php echo $fetch['SkillDevelopmentHistory']; ?></textarea>
                                    </div>
                                 </div>
                                 <div class="col-12">
