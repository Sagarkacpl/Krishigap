<?php
   ...
   $id=$_GET['id'];
   $edit = "SELECT * FROM `scheduledate` WHERE Id='$id'";
   ...
   if(isset($_POST['save']))
   {
       ...
       $insert = "UPDATE `scheduledate` SET Schedule='$story' WHERE Id='$id'";
       $execute = mysqli_query($db,$insert);
       if($execute == TRUE)
       {
            echo "<script>alert('Successfully Update')</script>";
            echo "<script>window.location.href='ScheduleDate.php'</script>";
       }
                              ...
                              <div class="expert-repeat" style="padding-top: 10px;">
                                 <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea class="form-control" id="editor1" rows="4" name="MostPopularCourse"><?php echo $fetch['Schedule']; ?></textarea>
                                    </div>
                                 </div>
                                 <div class="col-12">
