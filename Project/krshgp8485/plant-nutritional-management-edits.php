...
$plant_nutritional_management_id = $_GET['id'];
$query_edit = mysqli_query($db, "SELECT * from plant_nutritional_management where plant_nutritional_management_id = '$plant_nutritional_management_id'");
...
if (isset($_POST["GAPStandardWise"]) AND isset($_POST["CountryID"]) AND isset($_POST["CategoryId"])) {
    $query = mysqli_query($db, "UPDATE `plant_nutritional_management` SET `GAPStandardWise`='$_POST[GAPStandardWise]',`CountryID`='$_POST[CountryID]', `CategoryId`='$_POST[CategoryId]' WHERE `plant_nutritional_management_id`='$plant_nutritional_management_id'");
    if ($query) {
        ...
        header("Location:plant-nutritional-management-edits.php?id=$plant_nutritional_management_id&msg=success");
    } else {
        header("Location:plant-nutritional-management-edits.php?id=$plant_nutritional_management_id&msg=fail");
    }
}
?>
<!DOCTYPE html>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title float-left">Edit Crops Standards</h4>
                  <div class="card-title float-right"><a href="plant-nutritional-management-edit.php" class="btn btn-primary btn-sm">View List</a></div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-success">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Crops Standards details successfully edited.
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-danger">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Crops Standards details not edited.
                                       </div>
                                    </div>
                                 </div>
                              </div>
                          ...
                          <div class="form-group">
                            ...
                            <select name="GAPStandardWise" class="form-control" required="">
                              <option value="">Please Select</option>
                               <option <?php if($row_edit['GAPStandardWise'] == 'Agmark Standards'){echo "selected";} ?> value="Agmark Standards">Agmark Standards</option>
                               <option <?php if($row_edit['GAPStandardWise'] == 'Bureau of Indian Standards'){echo "selected";} ?> value="Bureau of Indian Standards">Bureau of Indian Standards</option>
                               <option <?php if($row_edit['GAPStandardWise'] == 'Central Seed Certification Board - Minimum Seed Certification Standards'){echo "selected";} ?> value="Central Seed Certification Board - Minimum Seed Certification Standards">Central Seed Certification Board - Minimum Seed Certification Standards</option>
                           </select>
                          </div>
                          </div>
