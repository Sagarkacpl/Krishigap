...
$query_edit = mysqli_query($db, "SELECT * from internal_inspection where InternalInspectionID  = '$InternalInspectionID'");
...
if (isset($_POST["GAPStandardWise"]) && isset($_POST["Crop"]) && isset($_POST["DocumentsTitle"]) && isset($_POST["VideoTitle"]) && isset($_POST["YoutubeVideoLink"]) && isset($_POST["TrainingModulesTitle"]) && isset($_POST["TrainingModulesLink"]) && isset($_POST["Remark"]) && isset($_POST["DocumentsSource"]) && isset($_POST["SourceLink"])) {
    ...
    $Document1 = time() . "-" . rand(1000, 9999) . "-DOC-" . $_FILES["Document"]["name"];
        ...
        $query = mysqli_query($db, "UPDATE `internal_inspection` SET `GAPStandardWise`='$GAPStandardWise', `Crop`='$Crop', `DocumentsTitle`='$DocumentsTitle', `VideoTitle`='$VideoTitle', `YoutubeVideoLink`='$YoutubeVideoLink', `TrainingModulesTitle`='$TrainingModulesTitle', `TrainingModulesLink`='$TrainingModulesLink', `Remark`='$Remark', `DocumentsSource`='$DocumentsSource', `SourceLink`='$SourceLink', `Language`='$Language' WHERE `InternalInspectionID`='$InternalInspectionID'"); 
        if ($query) {
            header("Location:internal-inspection-edits.php?id=$InternalInspectionID&msg=success");
        } else {
            header("Location:internal-inspection-edits.php?id=$InternalInspectionID&msg=fail");
        }
} ?>
<!DOCTYPE html>
<html lang="en">
               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left">Edit Internal Inspection</h4>
                              <div class="card-title float-right"><a href="internal-inspection-edit.php" class="btn btn-primary btn-sm">View List</a></div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-success">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Internal Inspection details successfully edited.
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-danger">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Internal Inspection details not edited.
                                       </div>
                                    </div>
                                 </div>
                              </div>
