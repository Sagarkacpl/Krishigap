                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="Date" type="date" class="form-control" id="" placeholder="Enter Date" required="">
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label for="">News Title</label>
                                                        <input name="NewsTitle" type="text" class="form-control" id="" placeholder="Enter Title" required="">
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-group">
                                ...
                                if(isset($_POST['submit']))
                                {
                                    ...
                                    $event = "INSERT INTO `event` SET Event_Date='$Date',Event_Title='$NewsTitle',Event_Desc='$Description',Event_img='$Event_img'";
