                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card mt-3">
                                <div class="card-body">
                                    <h4 class="card-title float-left">Skill Development History List
                                    </h4>
                                    <div class="card-title float-right">
                                        <a href="add_skill_dev.php" class="btn btn-primary btn-sm"
                                        ...
                                        <table id="example" class="table table-striped table-centered mb-0"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>End Date</th>
                                                    <th>Duration (Hr.)</th>
                                                    <th>No. of Registered Trainee</th>
                                                        ...
                                                        <td>
                                                            <p>
                                                                <a onclick="return confirm('Are you sure want to edit?')"
                                                                    href="edit_skill_development.php?id=<?php echo $read['Id']; ?>"
                                                                    class="badge badge-success"><i
                                                                        class="ti-pencil btn-icon-prepend"></i> Edit</a>

                                                                <a onclick="return confirm('Are you sure want to delete?')"
                                                                    href="delete_skill_development.php?delete=<?php echo $read['Id']; ?>"
