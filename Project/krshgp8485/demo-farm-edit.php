<?php
   ...
   $query = mysqli_query($db, "SELECT * from demo_farm where DeletedStatus='0' ORDER BY DemoFarmId DESC");
   if (isset($_POST["id"]) && isset($_POST["sort"])) {
       $id = mysqli_real_escape_string($db, $_POST["id"]);
       $sort = mysqli_real_escape_string($db, $_POST["sort"]); 
       $query = mysqli_query($db, "UPDATE `demo_farm` SET `sort`='$sort' WHERE `DemoFarmId`='$id'");
        if($query){
               header("Location:demo-farm-edit.php?msg=osuccess");
           }else{
               header("Location:demo-farm-edit.php?msg=ofail");
           }
       }
   ?>
<!DOCTYPE html>
               ...
               <div class="content-wrapper">
                  <div class="row">
                     <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                           <div class="card-body">
                              <h4 class="card-title float-left">List Demo Farm</h4>
                              <div class="card-title float-right"><a href="demo-farm-add.php" class="btn btn-primary btn-sm" style="padding: 0.4rem 1rem;">Add New</a></div>
                              ...
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-danger">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Demo Farm details not deleted..
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="bs-component">
                                       <div class="alert alert-dismissible alert-success">
                                          <button class="close" type="button" data-dismiss="alert">×</button>Demo Farm details successfully deleted.
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <table id="example" class="table table-striped table-borderless" style="width: 100% !important;">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <?php if($row['Document'] !=''){ ?>
                                             <a href="../demo-farm/<?php echo $row['Document']; ?>" target="_blank"><i style="font-size: 22px;" class="ti-files btn-icon-prepend"></i></a>
                                             <?php } ?>
                                          </td>
                                          <td>
                                             <form method="POST" action="">
                                                <input type="hidden" name="id" value="<?php echo $row['DemoFarmId']; ?>">
                                          ...
                                          <td class="font-weight-medium">
                                             <a onclick="return confirm('Are you sure want to edit?')" href="demo-farm-edits.php?id=<?php echo $row['DemoFarmId']; ?>" class="badge badge-success"><i class="ti-pencil btn-icon-prepend"></i> Edit</a>
                                             <a onclick="return confirm('Are you sure want to delete?')" href="demo-farm-delete.php?id=<?php echo $row['DemoFarmId']; ?>" class="badge badge-danger"><i class="ti-trash btn-icon-prepend"></i> Delete</a>
                                          </td>
                                          ...
                                          <td>
                                          <?php
                                          $queryf = mysqli_query($db,"SELECT * from demo_farm_documents where DeletedStatus='0' AND DemoFarmId='$row[DemoFarmId]' ORDER BY demo_farm_documents_id ASC");
                                       ...
                                       <?php } ?>
                                          ...
                                          <td><a href="demo-farm-documents.php?id=<?php echo $row['DemoFarmId']; ?>" target="_blank"><i style="font-size: 22px;" class="ti-files btn-icon-prepend"></i></a></td>
