   ...
   if (isset($_POST["Scheme"]) && isset($_POST["SchemeCategory"]) && isset($_POST["Documents"])) {
       ...
       if ($_FILES["document"]["name"] != '') {
           ...
           if (move_uploaded_file($_FILES["document"]["tmp_name"], "../MainPage_Others/" . $file)) {
               $query = mysqli_query($db, "INSERT INTO `mainpage_others` (`Id`, `Scheme`, `Scheme_Category`, `Documents`, `Users`, `DocumentUpload`, `Remark`, `Documents_Source`, `Source_Link`, `DeletedStatus`, `Created_Date`) VALUES (NULL, '$Scheme', '$SchemeCategory', '$Documents', '$users', '$file', '$Remark', '$DocumentsSource', '$SourceLink', '0', CURRENT_TIMESTAMP);");
               if ($query) {
                   header("Location:main_others.php?msg=success");
               } else {
                   header("Location:add_others.php?msg=fail");
               }
           }}
       }
   } ?>
            ...
            <div class="content-wrapper">
               <div class="row">
                  <div class="col-12 grid-margin stretch-card">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="card-title float-left" style="margin-top: 7px;">Add Other
                           </h4>
                                 ...
                                 <div class="bs-component">
                                    <div class="alert alert-dismissible alert-danger">
                                       <button class="close" type="button"
                                          data-dismiss="alert">×</button>Others details not saved.
                                    </div>
                                 </div>
                              </div>
                           </div>
                                 ...
                                 <div class="row">
                                    <div class="col-4">
                                       <div class="form-group">
                                          ...
                                          <select name="Scheme" class="form-control" required="">
                                             ...
                                             <option value="PGS-INDIA Organic">
                                                PGS-INDIA Organic
                                             </option>
                                             <option value="Packhouses for Horticulture Produce">
                                                Packhouses for Horticulture Produce
                                             </option>
                                             <option value="Cold Storages for Horticulture Produce">Cold
                                                Storages for Horticulture Produce
                                             </option>
                                             <option value="Food Testing Laboratories">Food Testing
                                                Laboratories
                                             </option>
                                             <option value="Dry Warehouses">Dry Warehouses</option>
                                             <option value="Medicinal Plants Certification">Medicinal Plants Certification</option>
                                          </select>
                                       </div>
                                    </div>
                                    <div class="col-4">
                                       <div class="form-group">
                                          ...
                                          <select name="SchemeCategory" class="form-control" required="">
                                             <option value="">Please Select</option>
                                             <option value="Agri Value Chain">Agri Value Chain
                                             </option>
                                          </select>
                                       </div>
                                    </div>
                                    <div class="col-4">
                                       <div class="form-group">
                                          ...
                                          <input type="text" name="Documents" class="form-control" name="" required="">
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       ...
                                       <div class="form-group row">
                                          <div class="col-sm-12">
                                             <div class="form-check">
                                                ...
                                                <input type="radio" class="form-check-input" name="users" id="" value="Farmer Producer Group/Food Processor/Exporter" required="">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="input-group col-xs-12">
                                             <input name="DocumentsSource" type="text"
                                                class="form-control" placeholder="Documents Source">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-12">
