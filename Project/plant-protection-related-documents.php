<?php
   ...
   $query = mysqli_query($db, "SELECT * from related_documents WHERE PageName = 'Plant Protection Products' AND GAPStandardWise = '$GETgsw' AND DeletedStatus='0' ORDER BY RelatedDocumentId ASC");
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-10 text-center">
                  <h1 class="display-3 text-white animated slideInDown">Plant Protection Products Related Documents</h1>
            ...
            <div class="col-md-4">
               ...
               <div class="form-floating">
                  <select id="gswselector" name="gsw" class="form-control" required="" onchange="if (this.value) window.location.href=this.value">
                     <option value="plant-protection-related-documents.php">All</option>
                                 <option <?php if($_GET['gsw'] == 'IndGAP'){echo "selected";} ?> value="plant-protection-related-documents.php?gsw=IndGAP">IndG.A.P</option>
                                 <option <?php if($_GET['gsw'] == 'GLOBALGAP'){echo "selected";} ?> value="plant-protection-related-documents.php?gsw=GLOBALGAP">GLOBALG.A.P</option>
                     </select>
               </div>
            </div>
            <div class="row g-4">
               <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                  <div class="row g-3">
                     ...
                     <div class="col-md-2">
                        ...
                        <a href="plant-protection-related-document-pdf.php?doc=<?php echo $row31['related_document_file_id']; ?>" target="_blank"><i style="font-size: 30px;" class="ti-files btn-icon-prepend"></i></a>
                        <?php }else{?>
