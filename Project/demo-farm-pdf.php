...
$DemoFarmId = $_GET['doc'];
$query = mysqli_query($db,"SELECT Document from demo_farm where DeletedStatus='0' and DemoFarmId='$DemoFarmId' ");
...
<iframe id="fraDisabled" src="demo-farm/<?php echo $row['Document']; ?>#toolbar=0" width="100%" height="600px"></iframe>
