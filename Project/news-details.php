         ...
         <div class="row">
          ...
          <!--  <div class="col-md-4">
            ...
            <?php } ?>
             ...
             <div class="page-detail-line">Hon'ble Prime Minister Vision for Global Standards is being fulfilled. India Good Agricultural Practices(IndG.A.P)  became equivalent to Global G.A.P ( www.globalgap.org), facilitating the export of Fruits and Vegetables from India to over 120 countries. It will boost the income of farmers and food processors
Benchmarking Recognition letter from Global G.A.P is attached</div>
            <center><img src="img/newsletter.jpg" class="page-detail-line"></center>
         </div>
      </div>
   </div>
