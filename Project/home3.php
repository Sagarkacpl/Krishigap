...
<html lang="en">
   ...
   <body>
      ...
      <div class="container-fluid p-0 mb-5 position-relative">
          <div onclick="history.back()" class="go-back-btn btn btn-success"><i class="fa fa-arrow-right"></i></div>
      ...
      <div class="container-xxl py-5" style="padding-top: 0rem !important;padding-bottom: 0rem !important;">
         ...
         <h1 class="text-center">Sustainable Standards</h1>
         
         <ul class="text-justify">
            <li>In this section, we have covered. ISO 14001  Environmental  Management, ISO 50001 Energy Management ISO 45001 Occupational health and safety SA 8000 Social Accountability International Rainforest Alliance Standard-wise Quality Manuals, Procedures, Record templates, Auditor's qualifications, Workers' Health and Welfare, and Government promotion schemes are available.</li>
                  ...
                  <div class="row">
                     <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item service-item-box-1 text-center position-relative">
                           <a href="food-safety-standards_SI.php">
                              <div class="m-img">
                                 <img src="img/foodsafety.jpg">
                              </div>
                              <div class="service-item-title service-item-title-1">Standards</div>
                           </a>
                        </div>
                     </div>
                     <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item service-item-box-1 text-center position-relative">
                           <a href="training-module.php">
                              ...
                              <div class="service-item-title service-item-title-1">Skills Development</div>
                           </a>
                        </div>
                     </div>
                     <!-- <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item service-item-box-3 text-center position-relative">
                           <a href="capacity-building-on-food-safety.php?page=home2">
                              <div class="m-img">
                                 <img src="img/skills-development.jpg">
                              </div>
                              <div style="padding-top: 0px;padding-bottom: 0px;" class="service-item-title service-item-title-3">Skills Development</div>
                           </a>
                        </div>
                     </div> -->
                     <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item service-item-box-5 text-center position-relative">
                           <a href="internal-audit_SI.php">
                              <div class="m-img">
                     ...
                     <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item service-item-box-3 text-center position-relative">
                           <?php
                              $queryf = mysqli_query($db,"SELECT DISTINCT Title from others_si where DeletedStatus='0' ORDER BY Title LIMIT 1");
                              $numother = mysqli_num_rows($queryf);
                              if($numother > 0){
                              while($rowf = mysqli_fetch_array($queryf)){
                              ?>
                           <a href="other-option_SI.php?nm=<?php echo $rowf['Title']; ?>&type=search">
                              <?php }}else{ ?>
                               <a href="other-option_SI.php">
                              <?php } ?>
                              <div class="m-img">
      ...
      <!-- <div class="container-xxl py-5" style="padding-top: 0rem !important;padding-bottom: 0rem !important; background-color:#f6f6f6;">
         <div class="container">
            <div class="col-md-12 text-center"><img src="img/coming-soon-img.png"></div>
         </div>
      </div> -->
