        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-12 text-center wow fadeInUp" data-wow-delay="0.3s" style="padding: 0px 200px;">
                    ...
                    <?php 
                        $story = "SELECT * FROM `training_module_short_story_PHP`";
                ...
                <div class="col-lg-12 text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="row g-5">
                        <div class="owl-carousel">
                            <?php
                        $schedule = "SELECT * , EXTRACT(YEAR FROM StartDate) AS Year, EXTRACT(MONTH FROM StartDate) AS Month FROM `schedule_PHP` WHERE EndDate > CURDATE() AND DeletedStatus='0'";
                ...
                <div class="col-lg-12 text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <?php 
                        $story = "SELECT * FROM `scheduledate_PHP`";
                        $StoryExe = mysqli_query($db,$story);
                        $ShortStory = mysqli_fetch_assoc($StoryExe);
                    ?>
                    <p class="mb-4">
                    ...
                    <p>
                        <a href="schedule-page_PHP.php" class="btn btn-primary">Learn More</a>
                    </p>
                </div>
                ...
                <div class="col-lg-12 text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <?php 
                        $story = "SELECT * FROM `skilldevelopmenthistory_PHP`";
                        $StoryExe = mysqli_query($db,$story);
                        $ShortStory = mysqli_fetch_assoc($StoryExe);
                    ?>
                    <p class="mb-4">
                    ...
                    <p>
                        <a href="skill-development-page_PHP.php" class="btn btn-primary">Learn More</a>
                    </p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $feedback = "INSERT INTO `training_module_feedback_PHP` SET Username='$username',Email='$email',Course='$course',Message='$message'";
                                $FormExe = mysqli_query($db,$feedback);
                                if($FormExe== TRUE)
                                {
                                    echo "<script>alert('Your Details Save Successfully')</script>";
                                    echo "<script>window.location.href = 'training-module_PHP.php'</script>";
                                }
                            }
                        ?>
                            </div>
                            ...
                            <div class="form-02 bg-white p-4 form-2-box">
                                ...
                                <?php
                                    if(isset($_POST['sendmessage']))
                                    {
                                        ...
                                        $Enquiry = "INSERT INTO `training_module_enquiry_PHP` SET Name='$name',Mobile='$mobile',Email='$mail',Position='$position',Organization='$organization',CourseInteresetd='$CourseInteresetd',Remark='$remark',Address='$address'";
