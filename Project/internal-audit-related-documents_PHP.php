<?php
  ...
  //  include "most_visited_page.php";
   if ($_GET['gsw'] != '') {
       ...
       $query = mysqli_query($db, "SELECT * from related_documents WHERE PageName = 'Internal Audit PHP' AND GAPStandardWise = '$GETgsw' AND DeletedStatus='0' ORDER BY RelatedDocumentId ASC");
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-10 text-center">
                  <h1 class="display-3 text-white animated slideInDown" style="font-size: 45px;">Internal Audit Related Documents (Post Harvest Processing)</h1>
            ...
            <div class="col-md-4">
               ...
               <div class="form-floating">
                  <select id="gswselector" name="gsw" class="form-control" required="" onchange="if (this.value) window.location.href=this.value">
                     <option value="internal-audit-related-documents_PHP.php">All</option>
                     <?php if (in_array('ISO 22000', explode(',',$_SESSION["PlanDetails"]))) {?>
                                 <option <?php if ($_GET['gsw'] == 'ISO22000') {echo "selected";} ?> value="internal-audit-related-documents_PHP.php?gsw=ISO22000">ISO 22000</option>
                                 <?php } ?>
                                 <?php if (in_array('FSSC 22000', explode(',',$_SESSION["PlanDetails"]))) {?>
                                 <option <?php if ($_GET['gsw'] == 'FSSC22000') {echo "selected";} ?> value="internal-audit-related-documents_PHP.php?gsw=FSSC22000">FSSC 22000</option>
                                 <?php } ?>
                                 <?php if (in_array('BRC Global Standard Packaging, Issue 6', explode(',',$_SESSION["PlanDetails"]))) {?>
                                 <option <?php if ($_GET['gsw'] == 'BRCGlobalStandardPackaging6') {echo "selected";} ?> value="internal-audit-related-documents_PHP.php?gsw=BRCGlobalStandardPackaging6">BRC Global Standard Packaging 6</option>
                                 <?php } ?>
                                 <?php if (in_array('BRC Global Standard Food Safety,Issue 9', explode(',',$_SESSION["PlanDetails"]))) {?>
                                 <option <?php if ($_GET['gsw'] == 'BRCGlobalStandardFoodSafety9') {echo "selected";} ?> value="internal-audit-related-documents_PHP.php?gsw=BRCGlobalStandardFoodSafety9">BRC Global Standard Food Safety 9</option>
                                 <?php } ?>
                    </select>
               </div>
            </div>
               ...
               <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                  <div class="row g-3">
                     ...
                     <div class="col-md-2">
                        ...
                        <a href="internal-audit-related-document-pdf.php?doc=<?php echo $row31['related_document_file_id']; ?>" target="_blank"><i style="font-size: 30px;" class="ti-files btn-icon-prepend"></i></a>
                        <?php }else{?>
