<?php
   ...
   $query = mysqli_query($db, "SELECT * from related_documents WHERE PageName = 'Workers Health Safety' AND GAPStandardWise = '$GETgsw' AND DeletedStatus='0' ORDER BY RelatedDocumentId ASC");
     }
   ?>
<!DOCTYPE html>
<html lang="en">
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-10 text-center">
                  <h1 class="display-3 text-white animated slideInDown">Workers Health, Safety & Welfare Related Documents</h1>
            ...
            <div class="col-md-4">
               ...
               <div class="form-floating">
                  <select id="gswselector" name="gsw" class="form-control" required="" onchange="if (this.value) window.location.href=this.value">
                     <option value="workers-health-related-documents.php">All</option>
                     <option value="workers-health-related-documents.php?gsw=IndGAP" <?php if($_GET['gsw'] == 'IndGAP'){echo "selected";} ?> value="IndGAP">IndG.A.P</option>
                     <option value="workers-health-related-documents.php?gsw=GLOBALGAP" <?php if($_GET['gsw'] == 'GLOBALGAP'){echo "selected";} ?> value="GLOBALGAP">GLOBALG.A.P</option>
                     <option value="workers-health-related-documents.php?gsw=OrganicNPOP" <?php if($_GET['gsw'] == 'OrganicNPOP'){echo "selected";} ?> value="OrganicNPOP">Organic NPOP</option>
                     <option value="workers-health-related-documents.php?gsw=OrganicNOP" <?php if($_GET['gsw'] == 'OrganicNOP'){echo "selected";} ?> value="OrganicNOP">Organic NOP</option>
                     <option value="workers-health-related-documents.php?gsw=FairtradeInternational" <?php if($_GET['gsw'] == 'FairtradeInternational'){echo "selected";} ?> value="FairtradeInternational">Fairtrade International</option>
                     <option value="workers-health-related-documents.php?gsw=RainforestAlliance" <?php if($_GET['gsw'] == 'RainforestAlliance'){echo "selected";} ?> value="RainforestAlliance">Rainforest Alliance</option>
                  </select>
               </div>
            </div>
            <div class="row g-4">
               <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                  <div class="row g-3">
                     ...
                     <div class="col-md-2">
                        ...
                        <a href="workers-health-related-document-pdf.php?doc=<?php echo $row31['related_document_file_id']; ?>" target="_blank"><i style="font-size: 30px;" class="ti-files btn-icon-prepend"></i></a>
                        <?php }else{?>
