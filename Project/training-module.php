...
if ($_SESSION['UID'] == '') {
    header("Location: login.php?page=OFP_SD");
   }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-12 text-center wow fadeInUp" data-wow-delay="0.3s" style="padding: 0px 200px;">
                    ...
                    <?php 
                        $story = "SELECT * FROM `training_module_short_story`";
                ...
                <div class="col-lg-12 text-center wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="row g-5">
                        <div class="owl-carousel">
                            <?php
                        $schedule = "SELECT * , EXTRACT(YEAR FROM StartDate) AS Year, EXTRACT(MONTH FROM StartDate) AS Month FROM `schedule` WHERE EndDate > CURDATE() AND DeletedStatus='0'";
                        ...
                        <!-- <div class="col-lg-4 wow fadeInLeft most-courses" data-wow-delay="0.3s">
                    <div class="popular-course">
                        <ul class="mt-4 mb-4">
                            <li><strong>Course</strong></li>
                            <li>Lorem lpsum</li>
                ...
                <div class="col-lg-12 text-center wow fadeInUp" data-wow-delay="0.3s">
                    <h1 class="mb-4">Schedule <a href="schedule-page.php" style="font-size: 20px;
    vertical-align: middle;">Click here</a></h1>
                    <?php 
                        $story = "SELECT * FROM `scheduledate`";
                        $StoryExe = mysqli_query($db,$story);
                        $ShortStory = mysqli_fetch_assoc($StoryExe);
                    ?>
                    <p class="mb-4">
                    ...
                    <!-- <p>
                        <a href="schedule-page.php" class="btn btn-primary">Learn More</a>
                    </p> -->
                </div>


                <div class="col-lg-12 text-center wow fadeInUp" data-wow-delay="0.3s">
                    <h1 class="mb-4">Skill Development History <a href="skill-development-page.php" style="font-size: 20px;
    vertical-align: middle;">Click here</a></h1>
                    <?php 
                        $story = "SELECT * FROM `skilldevelopmenthistory`";
                        $StoryExe = mysqli_query($db,$story);
                        $ShortStory = mysqli_fetch_assoc($StoryExe);
                    ?>
                    <p class="mb-4">
                    ...
                    <!-- <p>
                        <a href="skill-development-page.php" class="btn btn-primary">Learn More</a>
                    </p> -->
                </div>
                ...
                <div>
                    <div class="container-fluid p-0 mb-5">
                    <h1 class="mb-4 text-center">Testimonials</h1>
                        <div class="owl-carousel header-carousel position-relative">
                            ...
                            <div class="owl-carousel-item position-relative">
                                ...
                                <div class="col-lg-4 text-center">
                                    <h5 class="mb-3">Dr G. Yugandher</h5>
                                                                                          <p class="testimonial_subtitle"><span>Quality Manager</span><br>
                                                         <span>Andhra Pradesh State Organic Products Certification Authority</span>
                                                      </p>
                    ...
                    <div class="row">
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $feedback = "INSERT INTO `training_module_feedback` SET Username='$username',Email='$email',Course='$course',Message='$message'";
                                $FormExe = mysqli_query($db,$feedback);
                                if($FormExe== TRUE)
                                {
                                    echo "<script>alert('Your Details Save Successfully')</script>";
                                    echo "<script>window.location.href = 'training-module.php'</script>";
                                }
                            }
                        ?>
                            </div>
                            ...
                            <div class="form-02 bg-white p-4 form-2-box">
                                ...
                                <?php
                                    if(isset($_POST['sendmessage']))
                                    {
                                        ...
                                        $Enquiry = "INSERT INTO `training_module_enquiry` SET Name='$name',Mobile='$mobile',Email='$mail',Position='$position',Organization='$organization',CourseInteresetd='$CourseInteresetd',Remark='$remark',Address='$address'";
