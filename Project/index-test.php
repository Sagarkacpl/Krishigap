   ...
   <div class="container-fluid p-0 mb-5">
      <div class="owl-carousel header-carousel position-relative">
         <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/banner5.jpg" alt="banner5">
         </div>
         <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/banner6.jpg" alt="banner6">
         </div>
         <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/banner7-1.jpg" alt="banner7">
         </div>
         <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/pomegranatebanner.jpg" alt="pomegranatebanner">
         </div>
         <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/bananabanner.jpg" alt="bananabanner">
         </div>
         <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/basmatiricebanner.jpg" alt="basmatiricebanner">
         </div>
         <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/vegetablebanner.jpg" alt="vegetablebanner">
         </div>
         <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/mangotreebanner.jpg" alt="mangotreebanner">
         </div>
         <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="img/grapesbanner.jpg" alt="grapesbanner">
         </div>
      </div>
<!--
      ...
      <div class="container">
         ...
         <h3 class="text-center mb-5 title-m-1">An Overview on Krishi GAP</h3>
            <p class="text-justify">
               We bring global food safety standards to your doorstep. Facilitate, ease of implementation, and link you to the markets for certified produce. To make this possible, we have a one ‘Stop Solution’, which combines tools and advisories that are simple and easily 
               implementable. All records are avaliable in regional language ie , Hindi , Kannada, Marathi, Telugu , Tamil , Malayalam , Bengali, and Odia.<span id="dots">...</span>
            </p>
            <p class="text-justify">
                <strong>Krishigap is not involved in the certification of organizations, which will be done by independent bodies approved by the standard owner/National Accreditation Boards and the visitor is advised to visit their websites for the standards and updates</strong>
            </p>
            <span id="more">
            <p class="text-justify">
            ...
            <div class="text-center"><button onclick="TextReadMore()" id="myBtn" class="btn-sm btn-primary" style="border:0px; outline:none; color:#fff;">Read more</button></div>
            <div class="text-center mt-4">
               <p>
                  <a href="price-page.php" class="btn-sm btn-primary p-2" style="color:#fff;">New Subscription</a>
               </p>
            </div>
            <!-- <p style="text-align: center;margin-top: 15px;font-size: 21px;">For New Registeration, <a href="price-page.php" class="btn btn-success" target="_blank" >Click here</a></p> -->
<style>
   #more {display: none;}
</style> 
         </div>
                  ...
                  <div class="col-lg-2 col-sm-6">
                     <div class="service-item service-item-box-1 text-center position-relative home-box-bg-4">
                        <a href="https://premiummarket.krishigap.com/" id="liveAlertBtn2" target="_blank">
                           <div class="my-li-1 d-flex-g">
                              <h5 class="align-self-center text-center" style="color: #fff;">Market Linkage for Certified Organizations</h5>
                              <ul>
                                 <li>Buyer</li>
                                 <li>FPO/Supplier</li>
                              </ul>
         ...
         <div class="row mt-4">
            <div class="col-lg-2 wow fadeInLeft" data-wow-delay="0.3s"
               ...
               <div class="six-box-re green-bg">
                  <div class="six-box-icon"><img src="img/icon-1.png" alt="icon-1" style="width: 75px;"></div>
            ...
            <div class="col-lg-2 wow fadeInUp" data-wow-delay="0.3s"
               ...
               <div class="six-box-re skyblue-bg">
                  <div class="six-box-icon"><img src="img/icon-2.png" alt="icon-2" style="width: 75px;"></div>
            ...
            <div class="col-lg-2 wow fadeInRight" data-wow-delay="0.3s"
               ...
               <div class="six-box-re lightred-bg">
                  <div class="six-box-icon"><img src="img/icon-3.png" alt="icon-3" style="width: 75px;"></div>
            ...
            <div class="col-lg-2 wow fadeInLeft" data-wow-delay="0.3s"
               ...
               <div class="six-box-re greenlight-bg">
                  <div class="six-box-icon"><img src="img/icon-4.png" alt="icon-4" style="width: 75px;"></div>
            ...
            <div class="col-lg-2 wow fadeInUp" data-wow-delay="0.3s"
               ...
               <div class="six-box-re orange-bg">
                  <div class="six-box-icon"><img src="img/icon-5.png" alt="icon-5" style="width: 75px;"></div>
            ...
            <div class="col-lg-2 wow fadeInRight" data-wow-delay="0.3s"
               style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInRight;">
               <div class="six-box-re green-bg">
                  <div class="six-box-icon"><img src="img/icon-6.png" alt="icon-6.png" style="width: 75px;"></div>
