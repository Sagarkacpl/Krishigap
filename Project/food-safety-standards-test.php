<?php
   ...
   if (htmlspecialchars($_GET['sc'], ENT_QUOTES, "UTF-8") != '' AND htmlspecialchars($_GET['gsw'], ENT_QUOTES, "UTF-8") != '' AND htmlspecialchars($_GET['th1'], ENT_QUOTES, "UTF-8") != '' AND htmlspecialchars($_GET['od'], ENT_QUOTES, "UTF-8") != '' AND htmlspecialchars($_GET['crp'], ENT_QUOTES, "UTF-8") != '') {
    ...
    //   }
       if (in_array($GETgsw, explode(',',$_SESSION["PlanDetails"]))) {
               ...
               <form action="" method="GET">
                  <div class="row g-3">
                     <div class="col-md-9">
                           ...
                           <div class="col-md-6 mb-3 mt-2">
                              ...
                              <div class="form-floating">
                                 <select id="gswselector" name="gsw" class="form-control" required="">
                                    ...
                                    <?php if (in_array('IndG.A.P', explode(',',$_SESSION["PlanDetails"]))) {?>
                                    <option <?php if($_GET['gsw']=='IndGAP' ){echo "selected" ;} ?>
                                       value="IndGAP">IndG.A.P</option>
                                    <?php } ?>
                                    <?php }else{ ?>
                                    <?php if (in_array('IndG.A.P', explode(',',$_SESSION["PlanDetails"]))) {?>
                                    <option <?php if($_GET['gsw']=='IndGAP' ){echo "selected" ;} ?>
                                       value="IndGAP">IndG.A.P</option>
                                    <?php } ?>
                                    <?php if (in_array('GLOBALG.A.P', explode(',',$_SESSION["PlanDetails"]))) {?>
                                    <option <?php if($_GET['gsw']=='GLOBALGAP' ){echo "selected" ;} ?>
                                       value="GLOBALGAP">GLOBALG.A.P</option>
                                    <?php } ?>
                                    <?php if (in_array('Organic NPOP', explode(',',$_SESSION["PlanDetails"]))) {?>
                                    <option <?php if($_GET['gsw']=='OrganicNPOP' ){echo "selected" ;} ?>
                                       value="OrganicNPOP">Organic NPOP</option>
                                    <?php } ?>
                                    <?php if (in_array('Organic NOP', explode(',',$_SESSION["PlanDetails"]))) {?>
                                    <option <?php if($_GET['gsw']=='OrganicNOP' ){echo "selected" ;} ?>
                                       value="OrganicNOP">Organic NOP</option>
                                    <?php } ?>
                                    <?php if (in_array('Medicinal Plants', explode(',',$_SESSION["PlanDetails"]))) {?>
                                    <!--<option <?php if($_GET['gsw'] == 'Medicinal Plants'){echo "selected";} ?> value="Medicinal Plants">Medicinal Plants</option>-->
                                    <?php } ?>
                                    <?php } ?>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6 mb-3 mt-2">
                              ...
                              <div class="form-floating">
                                 <select name="crp" class="form-control" required="">
                                    ...
                                    <option <?php if($_GET['crp']==$row1['CropId']){echo "selected" ;} ?> value="
                                       <?php echo $row1['CropId']; ?>">
                                       <?php echo $row1['CropName']; ?>
                                    </option>
                                    <?php }} ?>
                                 </select>
                              </div>
                              ...
                              <div class="row">
                                 <div class="col-md-14">
                                    <div class="form-check m-form-check">
                                       <input <?php if($_GET['th1']=='Farmer Producer Group/Exporter' ){echo "checked"
                                          ;} ?> type="checkbox" class="form-check-input" name="th1" id="" value="Farmer Producer Group/Exporter">
                                       <label class="form-check-label" for="flexRadioDefault1">Farmer Producer Group/Exporter
                                       </label>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="col-md-6 mb-3 mt-2">
                              ...
                              <div class="form-floating">
                                 <select name="od" class="form-control" required="">
                                    <option></option>
                                    <option <?php if($_GET['od']=='Standard' ){echo "selected" ;} ?>
                                       value="Standard">Standard</option>
                                    <option <?php if($_GET['od']=='Quality Manual' ){echo "selected" ;} ?>
                                       value="Quality Manual">Quality Manual</option>
                                    <option <?php if($_GET['od']=='Procedures' ){echo "selected" ;} ?>
                                       value="Procedures">Procedures</option>
                                    <option <?php if($_GET['od']=='Risk Assessment' ){echo "selected" ;} ?> value="Risk
                                       Assessment">Risk Assessment</option>
                                    <option <?php if($_GET['od']=='Records' ){echo "selected" ;} ?>
                                       value="Records">Records</option>
                                    <option <?php if($_GET['od']=='Others' ){echo "selected" ;} ?> value="Others">Others
                                    </option>
                                 </select>
                              </div>
                           </div>
                        ...
                        <div class="col-md-2">
                           <h5>&nbsp;</h5>
                           <a href="food-safety-standards-about.php" target="_blank" style="color: #fff;"
                              class="btn btn-info w-100 py-3" type="submit">About This Section</a>
                        </div>
                        <div class="col-md-2">
                           <h5>&nbsp;</h5>
                           <a href="food-safety-standards-related-documents.php" target="_blank" style="color: #fff;"
                              class="btn btn-info w-100 py-3" type="submit">Related Documents</a>
                        </div>
                        <br>
                        <div class="gswww">
                        </div>
                        <div id="IndGAP" class="gsww" style="display:none">
                           <?php include ("food-safety-standards-IndG.A.P.php"); ?>
                        </div>
                        <div id="GLOBALGAP" class="gsww" style="display:none">
                           <?php include ("food-safety-standards-GLOBALGAP.php"); ?>
                        </div>
                        <div id="OrganicNPOP" class="gsww" style="display:none">
                           <?php include ("food-safety-standards-OrganicNPOP.php"); ?>
                        </div>
                        ...
                        <p style="text-align:justify;"><b>The visitor to the Krishi GAP platform is advised to visit the
                              standard owner website for the purchase or download of the standard copy and for accurate
                              information/updates on the standard requirements. A copy of the standard is not available
                              on the Krishi GAP site due to copyright regulations.</b></p>
                        <p style="text-align:center;margin-top: 0px !important;"><b>Quality Council of India: <a
                                 href="https://www.qcin.org" target="_blank">www.qcin.org</a></b></p>
                        <?php } if ($_GET['gsw'] == 'GLOBALGAP') {?>
                        <p style="text-align:justify;"><b>The visitor to the Krishi GAP platform is advised to visit the
                              standard owner website for the purchase or download of the standard copy and for accurate
                              information/updates on the standard requirements. A copy of the standard is not available
                              on the Krishi GAP site due to copyright regulations.</b></p>
                        <p style="text-align:center;margin-top: 0px !important;"><b>GlobalG.A.P: <a
                                 href="https://www.globalgap.org/uk_en" target="_blank">www.globalgap.org</a></b></p>
                        <?php } if ($_GET['gsw'] == 'OrganicNPOP') { ?>
                        <p style="text-align:justify;"><b>The visitor to the Krishi GAP platform is advised to visit the
                              standard owner website for the purchase or download of the standard copy and for accurate
                              information/updates on the standard requirements. A copy of the standard is not available
                              on the Krishi GAP site due to copyright regulations.</b></p>
                        <p style="text-align:center;margin-top: 0px !important;"><b>APEDA: <a
                                 href="https://apeda.gov.in/apedawebsite" target="_blank">www.apeda.gov.in</a></b></p>
                        <?php } if ($_GET['gsw'] == 'OrganicNOP') {?>
                        <p style="text-align:justify;"><b>The visitor to the Krishi GAP platform is advised to visit the
                              standard owner website for the purchase or download of the standard copy and for accurate
                              information/updates on the standard requirements. A copy of the standard is not available
                              on the Krishi GAP site due to copyright regulations.</b></p>
                        <p style="text-align:center;margin-top: 0px !important;"><b>USDA Agricultural Marketing Service:
                              <a href="https://www.ams.usda.gov" target="_blank">www.ams.usda.gov</a></b></p>
                        ...
                        <div class="col-md-2">
                           ...
                           <a href="food-safety-standards-pdf.php?doc=<?php echo $row31['food_safety_standards_documents_id']; ?>"
                              target="_blank"><i style="font-size: 30px;" class="ti-files btn-icon-prepend"></i></a>
                           <?php }else{?>
                           <a href="Food-Safety-Standards/<?php echo $row31['documents_name']; ?>" target="_blank"><i
                        ...
                        <div class="col-md-3">
                           <p style="overflow-y: auto;">
                              ...
                              <a href="<?php echo $row32['DocumentsSource']; ?>" target="_blank">
                        ...
                        <div class="col-md-3">
                           <p style="overflow-y: auto;">
                              ...
                              <a href="<?php echo $row32['SourceLink']; ?>" target="_blank">
