...
$query = mysqli_query($db,"SELECT Document from internal_audit where DeletedStatus='0' and InternalAuditID='$InternalAuditID' ");
...
<iframe id="fraDisabled" src="Internal_audit/<?php echo $row['Document']; ?>#toolbar=0" width="100%" height="600px"></iframe>
