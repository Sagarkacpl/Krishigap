<?php
 ...
 //   include "most_visited_page.php";
   if ($_GET['gsw'] != '') {
   $query = mysqli_query($db, "SELECT * from related_documents WHERE PageName = 'Crops Standards' AND GAPStandardWise = '$_GET[gsw]' AND DeletedStatus='0' ORDER BY RelatedDocumentId ASC");
     }
   ?>
<!DOCTYPE html>
<html lang="en">
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-10 text-center">
                  <h1 class="display-3 text-white animated slideInDown">Crops Standards Related Documents</h1>
            ...
            <div class="col-md-4">
               ...
               <div class="form-floating">
                  <select id="gswselector" name="gsw" class="form-control" required="" onchange="if (this.value) window.location.href=this.value">
                     <option value="crops-standards-related-documents.php">All</option>
                     <option value="crops-standards-related-documents.php?gsw=Agmark Standards" <?php if($_GET['gsw'] == 'Agmark Standards'){echo "selected";} ?> value="Agmark Standards">Agmark Standards</option>
                     <option value="crops-standards-related-documents.php?gsw=Bureau of Indian Standards" <?php if($_GET['gsw'] == 'Bureau of Indian Standards'){echo "selected";} ?> value="Bureau of Indian Standards">Bureau of Indian Standards</option>
                     <option value="crops-standards-related-documents.php?gsw=Central Seed Certification Board - Minimum Seed Certification Standards" <?php if($_GET['gsw'] == 'Central Seed Certification Board - Minimum Seed Certification Standards'){echo "selected";} ?> value="Central Seed Certification Board - Minimum Seed Certification Standards">Central Seed Certification Board - Minimum Seed Certification Standards</option>
               ...
               <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                  <div class="row g-3">
                     ...
                     <div class="col-md-2">
                        ...
                        <a href="crops-standards-related-document-pdf.php?doc=<?php echo $row31['related_document_file_id']; ?>" target="_blank"><i style="font-size: 30px;" class="ti-files btn-icon-prepend"></i></a>
                        <?php }else{?>
