                    ...
                    <table class="mt-5">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $trainee_list = "SELECT * FROM `schedule_SI` WHERE Course='$Course_name'";
                            ...
                            <tr>
                                ...
                                <td><a href="certificates_SI/<?php echo $read['Trainee_Certificate']; ?>" target="_blank"><img src="img/pdf.png" alt="" style="width: 26px;height: 30px;border-radius: 0%!important;"></a></td>
                            </tr>
                            <?php $count++; } ?>
                        </tbody>
                    </table>
