<?php
   ...
   $query = mysqli_query($db, "SELECT * from related_documents WHERE PageName = 'Standards SI' AND GAPStandardWise = '$GETgsw' AND DeletedStatus='0' ORDER BY RelatedDocumentId ASC");
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-10 text-center">
                  <h1 class="display-3 text-white animated slideInDown" style="font-size: 45px;">Standards Related Documents (Sustainable Initiatives)</h1>
            ...
            <div class="col-md-4">
               ...
               <div class="form-floating">
                  <select id="gswselector" name="gsw" class="form-control" required="" onchange="if (this.value) window.location.href=this.value">
                     <option value="food-safety-standards-related-documents_SI.php">All</option>
                                <option <?php if ($_GET['gsw'] == 'ISO 14001 Environment') {echo "selected";} ?> value="food-safety-standards-related-documents_SI.php?gsw=ISO 14001 Environment">ISO 14001- Environment</option>
                                <option <?php if ($_GET['gsw'] == 'ISO 50001 Energy Management') {echo "selected";} ?> value="food-safety-standards-related-documents_SI.php?gsw=ISO 50001 Energy Management">ISO 50001- Energy Management</option>
                                <option <?php if ($_GET['gsw'] == 'ISO 45001 OH and S Mgt') {echo "selected";} ?> value="food-safety-standards-related-documents_SI.php?gsw=ISO 45001 OH and S Mgt">ISO 45001 OH&S Mgt Systems</option>
                                <option <?php if ($_GET['gsw'] == 'SA 8000 Social Accounting') {echo "selected";} ?> value="food-safety-standards-related-documents_SI.php?gsw=SA 8000 Social Accounting">SA 8000- Social Accountability</option>
                                <option <?php if ($_GET['gsw'] == 'Rainforest Alliance') {echo "selected";} ?> value="food-safety-standards-related-documents_SI.php?gsw=Rainforest Alliance">Rainforest Alliance</option>
                      </select>
               </div>
            </div>
            <div class="row g-4">
               <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                  <div class="row g-3">
                     ...
                     <div class="col-md-2">
                        ...
                        <a href="food-safety-standards-related-document-pdf.php?doc=<?php echo $row31['related_document_file_id']; ?>" target="_blank"><i style="font-size: 30px;" class="ti-files btn-icon-prepend"></i></a>
                        <?php }else{?>
