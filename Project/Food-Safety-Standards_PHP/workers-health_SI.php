<?php
   ...
   if ($_GET['sc'] != '' AND $_GET['gsw'] != '') {
       if ($_GET['gsw'] == 'ISO 14001- Environment') {
              $GETgsw = 'ISO 14001- Environment';
          }
          if ($_GET['gsw'] == 'ISO 50001- Energy Management') {
              $GETgsw = 'ISO 50001- Energy Management';
          }
          if ($_GET['gsw'] == 'SA 8000- Social Accountability') {
              $GETgsw = 'SA 8000- Social Accountability';
          }
          if ($_GET['gsw'] == 'Rainforest Alliance') {
            $GETgsw = 'Rainforest Alliance';
         }
         if ($_GET['gsw'] == 'Fair Trade Certified') {
         $GETgsw = 'Fair Trade Certified';
     }
            ...
            <form action="" method="GET">
               <div class="row g-3">
                  ...
                  <div class="row g-3" style="margin-top: 0px;">
                     <div class="col-md-2">
                        <h5>&nbsp;</h5>
                        <a href="Workers-Health-Safety-&-Welfare-About_SI.pdf" target="_blank" style="color: #fff;" class="btn btn-info w-100 py-3" type="submit">About This Section</a>
                     </div>
                     <div class="col-md-2">
                        <h5>&nbsp;</h5>
